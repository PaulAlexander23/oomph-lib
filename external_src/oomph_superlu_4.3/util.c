...
/*! \brief Count the total number of nonzeros in factors L and U,  and in the
...
/*! \brief Fix up the data storage lsub for L-subscripts. It removes the
 * subscript sets for structural pruning,	and applies permuation to the
