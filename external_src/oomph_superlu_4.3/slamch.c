/*! @file slamch.c
 * \brief Determines single precision machine parameters and other service
 * routines
 *
 * <pre>
            ...
            float* rmax)
{
  ...
  static int lieee1;
  extern /* Subroutine */ int slamc1_(int*, int*, int*, int*);
  extern double slamc3_(float*, float*);
  extern /* Subroutine */ int slamc4_(int*, float*, int*),
    slamc5_(int*, int*, int*, int*, int*, float*);
