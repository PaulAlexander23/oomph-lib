...
extern "C"
{
  ...
  extern void dgssv(superlu_options_t*,
                    SuperMatrix*,
                    int*,
                    int*,
                    SuperMatrix*,
                    ...
                    SuperLUStat_t*,
                    int*);
  extern void dgssvx(superlu_options_t*,
                     SuperMatrix*,
                     int*,
                     int*,
                     int*,
                     ...
                     int*);
  /* ILU */
  extern void dgsisv(superlu_options_t*,
                     SuperMatrix*,
                     int*,
                     int*,
                     SuperMatrix*,
                     ...
                     SuperLUStat_t*,
                     int*);
  extern void dgsisx(superlu_options_t*,
                     SuperMatrix*,
                     int*,
                     int*,
                     int*,
  ...
  extern void dCreate_CompCol_Matrix(SuperMatrix*,
                                     ...
                                     Dtype_t,
                                     Mtype_t);
  extern void dCreate_CompRow_Matrix(SuperMatrix*,
                                     int,
                                     int,
                                     int,
                                     double*,
  ...
  extern void dCreate_Dense_Matrix(
    SuperMatrix*, int, int, double*, int, Stype_t, Dtype_t, Mtype_t);
  extern void dCreate_SuperNode_Matrix(SuperMatrix*,
                                       int,
                                       int,
                                       int,
                                       double*,
  ...
  extern void dgstrf(superlu_options_t*,
                     SuperMatrix*,
                     int,
                     int,
                     int*,
                     ...
                     SuperLUStat_t*,
                     int*);
  extern int dsnode_dfs(const int,
                        const int,
                        const int*,
                        const int*,
                        const int*,
                        ...
                        int*,
                        GlobalLU_t*);
  extern int dsnode_bmod(const int,
                         const int,
                         const int,
                         double*,
                         double*,
                         GlobalLU_t*,
                         SuperLUStat_t*);
  extern void dpanel_dfs(const int,
                         const int,
                         const int,
                         SuperMatrix*,
                         int*,
                         ...
                         int*,
                         GlobalLU_t*);
  extern void dpanel_bmod(const int,
                          const int,
                          const int,
                          const int,
                          double*,
                          ...
                          GlobalLU_t*,
                          SuperLUStat_t*);
  extern int dcolumn_dfs(const int,
                         const int,
                         int*,
                         int*,
                         int*,
                         ...
                         int*,
                         GlobalLU_t*);
  extern int dcolumn_bmod(const int,
                          const int,
                          double*,
                          double*,
                          int*,
  ...
  extern void dgstrs(trans_t,
                     ...
                     int*);
  /* ILU */
  extern void dgsitrf(superlu_options_t*,
                      SuperMatrix*,
                      int,
                      int,
                      int*,
                      ...
                      int*);
  extern int dldperm(
    int, int, int, int[], int[], double[], int[], double[], double[]);
  extern int ilu_dsnode_dfs(const int,
                            const int,
                            const int*,
                            const int*,
                            const int*,
                            int*,
                            GlobalLU_t*);
  extern void ilu_dpanel_dfs(const int,
                             const int,
                             const int,
                             SuperMatrix*,
                             int*,
                             ...
                             int*,
                             GlobalLU_t*);
  extern int ilu_dcolumn_dfs(const int,
                             const int,
                             int*,
                             int*,
                             int*,
                             ...
                             int*,
                             GlobalLU_t*);
  extern int ilu_dcopy_to_ucol(int,
                               int,
                               int*,
                               int*,
                               int*,
                               ...
                               GlobalLU_t*,
                               double*);
  extern int ilu_dpivotL(const int,
                         const double,
                         int*,
                         int*,
                         int,
                         ...
                         GlobalLU_t*,
                         SuperLUStat_t*);
  extern int ilu_ddrop_row(superlu_options_t*,
                           int,
                           int,
                           double,
                           int,
  ...
  extern double dPivotGrowth(
    int, SuperMatrix*, int*, SuperMatrix*, SuperMatrix*);
  extern void dgsrfs(trans_t,
                     SuperMatrix*,
                     SuperMatrix*,
                     SuperMatrix*,
                     int*,
  ...
  extern void dCompRow_to_CompCol(
