...
int sp_coletree(int* acolst,
                int* acolend, /* column start and end past 1 */
...
static
   ...
   * This routine was contributed by Cédric Doucet, CEDRAT Group, Meylan,
   * France.
   */
  void
  nr_etdfs(
    int n, int* parent, int* first_kid, int* next_kid, int* post, int postnum)
{
...
int sp_symetree(int* acolst,
                int* acolend, /* column starts and ends past 1 */
                int* arow, /* row indices of A */
