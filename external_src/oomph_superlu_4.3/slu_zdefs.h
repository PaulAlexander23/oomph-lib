...
extern "C"
{
  ...
  extern void zgssv(superlu_options_t*,
                    ...
                    SuperLUStat_t*,
                    int*);
  extern void zgssvx(superlu_options_t*,
                     SuperMatrix*,
                     int*,
                     int*,
                     int*,
                     ...
                     int*);
  /* ILU */
  extern void zgsisv(superlu_options_t*,
                     SuperMatrix*,
                     int*,
                     int*,
                     SuperMatrix*,
                     ...
                     SuperLUStat_t*,
                     int*);
  extern void zgsisx(superlu_options_t*,
                     SuperMatrix*,
                     int*,
                     int*,
                     int*,
  ...
  extern void zCreate_CompCol_Matrix(SuperMatrix*,
                                     ...
                                     Dtype_t,
                                     Mtype_t);
  extern void zCreate_CompRow_Matrix(SuperMatrix*,
                                     int,
                                     int,
                                     int,
                                     doublecomplex*,
  ...
  extern void zCreate_Dense_Matrix(
    SuperMatrix*, int, int, doublecomplex*, int, Stype_t, Dtype_t, Mtype_t);
  extern void zCreate_SuperNode_Matrix(SuperMatrix*,
                                       int,
                                       int,
                                       int,
                                       doublecomplex*,
                                       ...
                                       Dtype_t,
                                       Mtype_t);
  extern void zCopy_Dense_Matrix(
  ...
  extern void zgstrf(superlu_options_t*,
                     SuperMatrix*,
                     int,
                     int,
                     int*,
                     ...
                     SuperLUStat_t*,
                     int*);
  extern int zsnode_dfs(const int,
                        const int,
                        const int*,
                        const int*,
                        const int*,
                        ...
                        int*,
                        GlobalLU_t*);
  extern int zsnode_bmod(const int,
                         const int,
                         const int,
                         doublecomplex*,
                         doublecomplex*,
                         GlobalLU_t*,
                         SuperLUStat_t*);
  extern void zpanel_dfs(const int,
                         const int,
                         const int,
                         SuperMatrix*,
                         int*,
                         ...
                         int*,
                         GlobalLU_t*);
  extern void zpanel_bmod(const int,
                          const int,
                          const int,
                          const int,
                          doublecomplex*,
                          ...
                          GlobalLU_t*,
                          SuperLUStat_t*);
  extern int zcolumn_dfs(const int,
                         const int,
                         int*,
                         int*,
                         int*,
                         ...
                         int*,
                         GlobalLU_t*);
  extern int zcolumn_bmod(const int,
                          const int,
                          doublecomplex*,
                          doublecomplex*,
                          int*,
                          ...
                          GlobalLU_t*,
                          SuperLUStat_t*);
  extern int zcopy_to_ucol(
    int, int, int*, int*, int*, doublecomplex*, GlobalLU_t*);
  extern int zpivotL(const int,
                     const double,
                     int*,
                     int*,
                     int*,
  ...
  extern void zFillRHS(
    trans_t, int, doublecomplex*, int, SuperMatrix*, SuperMatrix*);
  extern void zgstrs(trans_t,
                     SuperMatrix*,
                     SuperMatrix*,
                     int*,
                     int*,
                     ...
                     int*);
  /* ILU */
  extern void zgsitrf(superlu_options_t*,
                      SuperMatrix*,
                      int,
                      int,
                      int*,
                      ...
                      int*);
  extern int zldperm(
    int, int, int, int[], int[], doublecomplex[], int[], double[], double[]);
  extern int ilu_zsnode_dfs(const int,
                            const int,
                            const int*,
                            const int*,
                            const int*,
                            int*,
                            GlobalLU_t*);
  extern void ilu_zpanel_dfs(const int,
                             const int,
                             const int,
                             SuperMatrix*,
                             int*,
                             ...
                             int*,
                             GlobalLU_t*);
  extern int ilu_zcolumn_dfs(const int,
                             const int,
                             int*,
                             int*,
                             int*,
                             ...
                             int*,
                             GlobalLU_t*);
  extern int ilu_zcopy_to_ucol(int,
                               int,
                               int*,
                               int*,
                               int*,
                               ...
                               GlobalLU_t*,
                               double*);
  extern int ilu_zpivotL(const int,
                         const double,
                         int*,
                         int*,
                         int,
                         ...
                         GlobalLU_t*,
                         SuperLUStat_t*);
  extern int ilu_zdrop_row(superlu_options_t*,
                           int,
                           int,
                           double,
                           int,
  ...
  extern void zgsequ(
    SuperMatrix*, double*, double*, double*, double*, double*, int*);
  extern void zlaqgs(
    SuperMatrix*, double*, double*, double, double, double, char*);
  extern void zgscon(
    char*, SuperMatrix*, SuperMatrix*, double, double*, SuperLUStat_t*, int*);
  extern double zPivotGrowth(
    int, SuperMatrix*, int*, SuperMatrix*, SuperMatrix*);
  extern void zgsrfs(trans_t,
                     SuperMatrix*,
                     SuperMatrix*,
                     SuperMatrix*,
                     int*,
  ...
  extern int zLUMemInit(fact_t,
                        ...
                        int**,
                        doublecomplex**);
  extern void zSetRWork(
    int, int, doublecomplex*, doublecomplex**, doublecomplex**);
  ...
  extern void zCompRow_to_CompCol(
    int, int, int, doublecomplex*, int*, int*, doublecomplex**, int**, int**);
  extern void zfill(doublecomplex*, int, doublecomplex);
  extern void zinf_norm_error(int, SuperMatrix*, doublecomplex*);
  extern void PrintPerf(SuperMatrix*,
                        SuperMatrix*,
                        mem_usage_t*,
                        doublecomplex,
                        doublecomplex,
