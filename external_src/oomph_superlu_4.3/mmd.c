...
/* Subroutine */ int genmmd_(int* neqns,
                             int* xadj,
                             shortint* adjncy,
                             shortint* invp,
                             shortint* perm,
                             ...
                             int* nofsub)
{
  ...
  extern /* Subroutine */ int mmdelm_(int*,
                                      int*,
                                      shortint*,
                                      shortint*,
                                      shortint*,
...
/* Subroutine */ int mmdint_(int* neqns,
                             int* xadj,
                             shortint* adjncy,
                             shortint* dhead,
                             shortint* dforw,
...
/* Subroutine */ int mmdelm_(int* mdnode,
                             int* xadj,
                             shortint* adjncy,
                             shortint* dhead,
                             shortint* dforw,
                             ...
                             int* tag)
{
  ...
  /* Local variables */
  static int node, link, rloc, rlmt, i, j, nabor, rnode, elmnt, xqnbr, istop,
...
/* Subroutine */ int mmdupd_(int* ehead,
                             int* neqns,
                             int* xadj,
                             shortint* adjncy,
                             int* delta,
                             ...
                             int* tag)
{
  ...
  /* Local variables */
  static int node, mtag, link, mdeg0, i, j, enode, fnode, nabor, elmnt, istop,
...
/* Subroutine */ int mmdnum_(int* neqns,
                             shortint* perm,
                             shortint* invp,
                             shortint* qsize)
{
