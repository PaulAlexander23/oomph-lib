...
extern "C"
{
  ...
  extern void cgssv(superlu_options_t*,
                    SuperMatrix*,
                    int*,
                    int*,
                    SuperMatrix*,
                    ...
                    SuperLUStat_t*,
                    int*);
  extern void cgssvx(superlu_options_t*,
                     SuperMatrix*,
                     int*,
                     int*,
                     int*,
                     ...
                     int*);
  /* ILU */
  extern void cgsisv(superlu_options_t*,
                     SuperMatrix*,
                     int*,
                     int*,
                     SuperMatrix*,
                     ...
                     SuperLUStat_t*,
                     int*);
  extern void cgsisx(superlu_options_t*,
                     SuperMatrix*,
                     int*,
                     int*,
                     int*,
  ...
  extern void cCreate_CompCol_Matrix(SuperMatrix*,
                                     int,
                                     int,
                                     int,
                                     complex*,
                                     ...
                                     Dtype_t,
                                     Mtype_t);
  extern void cCreate_CompRow_Matrix(SuperMatrix*,
                                     int,
                                     int,
                                     int,
                                     complex*,
  ...
  extern void cCreate_Dense_Matrix(
    SuperMatrix*, int, int, complex*, int, Stype_t, Dtype_t, Mtype_t);
  extern void cCreate_SuperNode_Matrix(SuperMatrix*,
                                       int,
                                       int,
                                       int,
                                       complex*,
  ...
  extern void cgstrf(superlu_options_t*,
                     SuperMatrix*,
                     int,
                     int,
                     int*,
                     ...
                     SuperLUStat_t*,
                     int*);
  extern int csnode_dfs(const int,
                        const int,
                        const int*,
                        const int*,
                        const int*,
                        ...
                        int*,
                        GlobalLU_t*);
  extern int csnode_bmod(const int,
                         const int,
                         const int,
                         complex*,
                         complex*,
                         GlobalLU_t*,
                         SuperLUStat_t*);
  extern void cpanel_dfs(const int,
                         const int,
                         const int,
                         SuperMatrix*,
                         int*,
                         ...
                         int*,
                         GlobalLU_t*);
  extern void cpanel_bmod(const int,
                          const int,
                          const int,
                          const int,
                          complex*,
                          ...
                          GlobalLU_t*,
                          SuperLUStat_t*);
  extern int ccolumn_dfs(const int,
                         const int,
                         int*,
                         int*,
                         int*,
                         ...
                         int*,
                         GlobalLU_t*);
  extern int ccolumn_bmod(const int,
                          const int,
                          complex*,
                          complex*,
                          int*,
                          ...
                          GlobalLU_t*,
                          SuperLUStat_t*);
  extern int ccopy_to_ucol(int, int, int*, int*, int*, complex*, GlobalLU_t*);
  extern int cpivotL(const int,
                     const double,
                     int*,
                     int*,
                     int*,
  ...
  extern void cFillRHS(trans_t, int, complex*, int, SuperMatrix*, SuperMatrix*);
  extern void cgstrs(trans_t,
                     SuperMatrix*,
                     SuperMatrix*,
                     int*,
                     int*,
                     ...
                     int*);
  /* ILU */
  extern void cgsitrf(superlu_options_t*,
                      SuperMatrix*,
                      int,
                      int,
                      int*,
                      ...
                      int*);
  extern int cldperm(
    int, int, int, int[], int[], complex[], int[], float[], float[]);
  extern int ilu_csnode_dfs(const int,
                            const int,
                            const int*,
                            const int*,
                            const int*,
                            int*,
                            GlobalLU_t*);
  extern void ilu_cpanel_dfs(const int,
                             const int,
                             const int,
                             SuperMatrix*,
                             int*,
                             ...
                             int*,
                             GlobalLU_t*);
  extern int ilu_ccolumn_dfs(const int,
                             const int,
                             int*,
                             int*,
                             int*,
                             ...
                             int*,
                             GlobalLU_t*);
  extern int ilu_ccopy_to_ucol(int,
                               int,
                               int*,
                               int*,
                               int*,
                               ...
                               GlobalLU_t*,
                               float*);
  extern int ilu_cpivotL(const int,
                         const double,
                         int*,
                         int*,
                         int,
                         ...
                         GlobalLU_t*,
                         SuperLUStat_t*);
  extern int ilu_cdrop_row(superlu_options_t*,
                           int,
                           int,
                           double,
                           int,
  ...
  extern float cPivotGrowth(
    int, SuperMatrix*, int*, SuperMatrix*, SuperMatrix*);
  extern void cgsrfs(trans_t,
                     SuperMatrix*,
                     SuperMatrix*,
                     SuperMatrix*,
                     int*,
  ...
  extern int sp_ctrsv(char*,
                      ...
                      int*);
  extern int sp_cgemv(
    char*, complex, SuperMatrix*, complex*, int, complex, complex*, int);

  extern int sp_cgemm(char*,
                      char*,
                      int,
                      int,
                      int,
  ...
  extern void cCompRow_to_CompCol(
    int, int, int, complex*, int*, int*, complex**, int**, int**);
