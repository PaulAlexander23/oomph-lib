      ...
      for (k = 0; k <= Lstore->nsuper; k++)
      {
        ...
        else
        {
          ...
          CGEMV(ftcs2,
                ...
                &incy);
#else
          ctrsv_("L", "N", "U", &nsupc, &Lval[luptr], &nsupr, &x[fsupc], &incx);
      ...
      for (k = Lstore->nsuper; k >= 0; k--)
      {
        ...
        else
        {
          ...
          CTRSV(ftcs3,
                ...
                &incx);
#else
          ctrsv_("U", "N", "N", &nsupc, &Lval[luptr], &nsupr, &x[fsupc], &incx);
#endif
#else
      ...
      for (k = Lstore->nsuper; k >= 0; --k)
      {
        ...
        if (nsupc > 1)
        {
          ...
          CTRSV(ftcs1,
                ...
                &incx);
#else
          ctrsv_("L", "T", "U", &nsupc, &Lval[luptr], &nsupr, &x[fsupc], &incx);
#endif
        }
      }
    }
      ...
      for (k = 0; k <= Lstore->nsuper; k++)
      {
        ...
        else
        {
          ...
          CTRSV(ftcs1,
                ...
                &incx);
#else
          ctrsv_("U", "T", "N", &nsupc, &Lval[luptr], &nsupr, &x[fsupc], &incx);
#endif
        }
      } /* for k ... */
    }
...
#else
          ctrsv_(
            "L", trans, "U", &nsupc, &Lval[luptr], &nsupr, &x[fsupc], &incx);
#endif
        }
      }
    }
...
#else
          ctrsv_(
            "U", trans, "N", &nsupc, &Lval[luptr], &nsupr, &x[fsupc], &incx);
#endif
        }
      } /* for k ... */
    }
...
/*! \brief Performs one of the matrix-vector operations y := alpha*A*x + beta*y,
