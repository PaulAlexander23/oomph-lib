...
void ParallelTotalVReMap(
  CtrlType*, idxtype*, idxtype*, WorkSpaceType*, int, int);
...
/* redomylink.c */
void RedoMyLink(
  CtrlType*, GraphType*, idxtype*, int, int, float*, float*, float*);
...
/* mdiffusion.c */
int Mc_Diffusion(
  CtrlType*, GraphType*, idxtype*, idxtype*, idxtype*, WorkSpaceType*, int);
...
void Serial_SelectQueue(
  int, float*, float*, int*, int*, FPQueueType[MAXNCON][2]);
...
/* xyzpart.c */
void Coordinate_Partition(
  CtrlType*, GraphType*, int, float*, int, WorkSpaceType*);
...
void PrintTransferedGraphs(
  CtrlType*, int, idxtype*, idxtype*, idxtype*, idxtype*, idxtype*);
...
/* grsetup.c */
GraphType* Mc_SetUpGraph(
  CtrlType*, int, idxtype*, idxtype*, idxtype*, idxtype*, idxtype*, int*);
...
void METIS_mCPartGraphRecursive2(int*,
                                 ...
                                 int*,
                                 idxtype*);
int MCMlevelRecursiveBisection2(
  CtrlType*, GraphType*, int, float*, idxtype*, float, int);
...
GraphType* SetUpGraph(
  CtrlType*, idxtype*, idxtype*, idxtype*, idxtype*, idxtype*, int);
