                       ...
                       MPI_Comm* comm)
{
  ...
  for (i = 0; i < *nparts * ncon; i++) tpwgts[i] = 1.0 / (float)(*nparts);
...
/***********************************************************************************
 * * This function is the entry point of the parallel k-way multilevel
 * partitionioner.
                           ...
                           MPI_Comm* comm)
{
  ...
  ParMETIS_V3_PartGeomKway(vtxdist,
                           xadj,
                           adjncy,
                           vwgt,
                           adjwgt,
                ...
                MPI_Comm comm)
{
  ...
  ParMETIS_PartGeomRefine(vtxdist,
                          xadj,
                          adjncy,
                          vwgt,
                          adjwgt,
                         ...
                         MPI_Comm* comm)
{
  ...
  ParMETIS_V3_RefineKway(vtxdist,
                         xadj,
                         adjncy,
                         vwgt,
                         adjwgt,
...
/***********************************************************************************
 * This function is the entry point of the parallel k-way multilevel
 *partitionioner. This function assumes nothing about the graph distribution. It
 *is the general case.
 ************************************************************************************/
                               ...
                               MPI_Comm* comm)
{
  ...
  ParMETIS_V3_AdaptiveRepart(vtxdist,
                             xadj,
                             adjncy,
                             vwgt,
                             NULL,
...
/***********************************************************************************
 * This function is the entry point of the parallel multilevel undirected
 *diffusion algorithm. It uses parallel undirected diffusion followed by
 *adaptive k-way refinement. This function utilizes local coarsening.
 ************************************************************************************/
                ...
                MPI_Comm comm)
{
  ...
  ParMETIS_RepartLDiffusion(vtxdist,
                            xadj,
                            adjncy,
                            vwgt,
                            adjwgt,
...
/***********************************************************************************
 * This function is the entry point of the parallel multilevel directed
 *diffusion algorithm. It uses parallel undirected diffusion followed by
 *adaptive k-way refinement. This function utilizes local coarsening.
 ************************************************************************************/
                ...
                MPI_Comm comm)
{
  ...
  ParMETIS_RepartGDiffusion(vtxdist,
                            xadj,
                            adjncy,
                            vwgt,
                            adjwgt,
                     ...
                     MPI_Comm* comm)
{
  ...
  ParMETIS_V3_NodeND(
    vtxdist, xadj, adjncy, numflag, myoptions, order, sizes, comm);
}
