...
// si@wias-berlin.de                                                         //
//                                                                           //
// TetGen is freely available through the website:
...
public:
  ...
  // array // addesses a particular object in the pool.  The most significant
...
#define fastlookup(pool, index) \
  ...
  enum interresult tri_edge_inter_tail(
  ...
  bool removeedgebycombNM(
    REAL*, int, triface*, int*, triface*, triface*, queue*);
  ...
  enum locateresult insertvertexbw(point insertpt,
                                   triface* searchtet,
                                   bool bwflag,
                                   bool visflag,
                                   bool noencsegflag,
  ...
  enum locateresult sinsertvertex(
    point insertpt, face* splitsh, face* splitseg, bool bwflag, bool cflag);
  ...
  void interecursive(shellface** subfacearray,
                     int arraysize,
                     int axis,
                     REAL bxmin,
                     REAL bxmax,
  ...
  void initializecavity(list* floorlist,
                        list* ceillist,
                        list* frontlist,
                        list* ptlist,
                        list* gluelist);
  ...
  void gluefronts(triface* front,
                  triface* front1,
                  list* gluetetlist,
                  list* glueshlist);
  bool identifyfronts(list* frontlist,
                      list* misfrontlist,
                      list* gluetetlist,
                      list* glueshlist);
  void detachauxsubfaces(list* newtetlist);
  bool carvecavity(list* newtetlist,
                   list* outtetlist,
                   list* gluetetlist,
                   queue* flipque);
  ...
  bool registerelemflip(enum fliptype ft,
                        point pa1,
                        point pb1,
                        point pc1,
                        point pa2,
  ...
  bool constrainedcavity(triface* oldtet,
                         list* floorlist,
                         list* ceillist,
                         list* ptlist,
                         list* frontlist,
  ...
  bool suppressfacetpoint(face* supsh,
                          list* frontlist,
                          list* misfrontlist,
                          list* ptlist,
                          list* conlist,
                          ...
                          bool noreloc,
                          bool optflag);
  bool suppresssegpoint(face* supseg,
                        list* spinshlist,
                        list* newsegshlist,
                        list* frontlist,
                        list* misfrontlist,
                        ...
                        bool noreloc,
                        bool optflag);
  bool suppressvolpoint(triface* suptet,
                        list* frontlist,
                        list* misfrontlist,
                        list* ptlist,
                        queue* flipque,
...
inline void tetgenmesh::setelemattribute(tetrahedron* ptr,
                                         int attnum,
                                         REAL value)
{
...
inline void tetgenmesh::setshellmark(face& s, int value)
{
  ((int*)((s).sh))[shmarkindex] =
    (value << (int)2) + ((((int*)((s).sh))[shmarkindex]) & (int)3);
...
{
  ((int*)((s).sh))[shmarkindex] = (((int*)((s).sh))[shmarkindex] | (int)1);
...
inline bool tetgenmesh::isdead(triface* t)
{
  if (t->tet == (tetrahedron*)NULL) return true;
    ...
    return t->tet[4] == (tetrahedron)NULL;
}
...
{
  tetrahedron* ptr =
    (tetrahedron*)((unsigned long)(t->tet[t->loc]) & ~(unsigned long)7l);
  return ptr != dummytet;
}
