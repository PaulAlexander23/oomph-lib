...
/* compress.c */
void CompressGraph(
  CtrlType*, GraphType*, int, idxtype*, idxtype*, idxtype*, idxtype*);
void PruneGraph(
  CtrlType*, GraphType*, int, idxtype*, idxtype*, idxtype*, float);
...
int ComputeCoarseGraphSize(
  int, idxtype*, idxtype*, int, idxtype*, idxtype*, idxtype*);
...
void METIS_NODEWND(
  int*, idxtype*, idxtype*, idxtype*, int*, int*, idxtype*, idxtype*);
void metis_nodewnd(
  int*, idxtype*, idxtype*, idxtype*, int*, int*, idxtype*, idxtype*);
void metis_nodewnd_(
  int*, idxtype*, idxtype*, idxtype*, int*, int*, idxtype*, idxtype*);
void metis_nodewnd__(
  int*, idxtype*, idxtype*, idxtype*, int*, int*, idxtype*, idxtype*);
void METIS_PARTMESHNODAL(
  int*, int*, idxtype*, int*, int*, int*, int*, idxtype*, idxtype*);
void metis_partmeshnodal(
  int*, int*, idxtype*, int*, int*, int*, int*, idxtype*, idxtype*);
void metis_partmeshnodal_(
  int*, int*, idxtype*, int*, int*, int*, int*, idxtype*, idxtype*);
void metis_partmeshnodal__(
  int*, int*, idxtype*, int*, int*, int*, int*, idxtype*, idxtype*);
void METIS_PARTMESHDUAL(
  int*, int*, idxtype*, int*, int*, int*, int*, idxtype*, idxtype*);
void metis_partmeshdual(
  int*, int*, idxtype*, int*, int*, int*, int*, idxtype*, idxtype*);
void metis_partmeshdual_(
  int*, int*, idxtype*, int*, int*, int*, int*, idxtype*, idxtype*);
void metis_partmeshdual__(
  int*, int*, idxtype*, int*, int*, int*, int*, idxtype*, idxtype*);
...
/* graph.c */
void SetUpGraph(
  GraphType*, int, int, int, idxtype*, idxtype*, idxtype*, idxtype*, int);
...
void Random_KWayVolRefineMConn(
  CtrlType*, GraphType*, int, float*, float, int, int);
...
void KWayVolUpdate(
  CtrlType*, GraphType*, int, int, int, idxtype*, idxtype*, idxtype*);
...
void SelectQueue3(
  int, float*, float*, int*, int*, PQueueType[MAXNCON][2], float*);
...
int MinCover_Augment(
  idxtype*, idxtype*, int, idxtype*, idxtype*, idxtype*, int);
...
void MCGreedy_KWayEdgeBalanceHorizontal(
  CtrlType*, GraphType*, int, float*, int);
...
void METIS_mCHPartGraphRecursive(int*,
                                 ...
                                 int*,
                                 idxtype*);
void METIS_mCPartGraphRecursiveInternal(
  int*, int*, idxtype*, idxtype*, float*, idxtype*, int*, int*, int*, idxtype*);
void METIS_mCHPartGraphRecursiveInternal(int*,
                                         ...
                                         int*,
                                         idxtype*);
int MCMlevelRecursiveBisection(
  CtrlType*, GraphType*, int, idxtype*, float, int);
int MCHMlevelRecursiveBisection(
  CtrlType*, GraphType*, int, idxtype*, float*, int);
...
int SplitGraphOrderCC(
  CtrlType*, GraphType*, GraphType*, int, idxtype*, idxtype*);
...
void METIS_WPartGraphKway2(int*,
                           ...
                           idxtype*);
void METIS_NodeNDP(
  int, idxtype*, idxtype*, int, int*, idxtype*, idxtype*, idxtype*);
void MlevelNestedDissectionP(
  CtrlType*, GraphType*, idxtype*, int, int, int, idxtype*);
void METIS_NodeComputeSeparator(
  int*, idxtype*, idxtype*, idxtype*, idxtype*, int*, int*, idxtype*);
void METIS_EdgeComputeSeparator(
  int*, idxtype*, idxtype*, idxtype*, idxtype*, int*, int*, idxtype*);
...
void METIS_WPartGraphRecursive(int*,
                               ...
                               int*,
                               idxtype*);
int MlevelRecursiveBisection(
  CtrlType*, GraphType*, int, idxtype*, float*, float, int);
...
/* subdomains.c */
void Random_KWayEdgeRefineMConn(
  CtrlType*, GraphType*, int, float*, float, int, int);
void Greedy_KWayEdgeBalanceMConn(
  CtrlType*, GraphType*, int, float*, float, int);
...
void MoveGroupMConn(
  CtrlType*, GraphType*, idxtype*, idxtype*, int, int, int, idxtype*);
...
int VerifyWPart(
  int, idxtype*, idxtype*, idxtype*, idxtype*, int, float*, int, idxtype*);
...
int VerifyPartmC(
  int, int, idxtype*, idxtype*, idxtype*, idxtype*, int, float*, int, idxtype*);
