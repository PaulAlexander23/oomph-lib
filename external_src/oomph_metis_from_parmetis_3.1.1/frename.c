 ...
 * frename.c
 *
 * This file contains some renaming routines to deal with different Fortran
 * compilers
 *
 * Started 9/15/97
 * George
...
void METIS_MCPARTGRAPHRECURSIVE(int* nvtxs,
                                ...
                                idxtype* part)
{
  METIS_mCPartGraphRecursive(nvtxs,
                             ncon,
                             xadj,
                             adjncy,
                             vwgt,
...
void metis_partgraphvkaway(int* nvtxs,
                           idxtype* xadj,
                           idxtype* adjncy,
                           idxtype* vwgt,
                           idxtype* vsize,
...
void metis_partgraphvkaway_(int* nvtxs,
                            idxtype* xadj,
                            idxtype* adjncy,
                            idxtype* vwgt,
                            idxtype* vsize,
...
void metis_partgraphvkaway__(int* nvtxs,
                             idxtype* xadj,
                             idxtype* adjncy,
                             idxtype* vwgt,
                             idxtype* vsize,
...
void metis_wpartgraphvkaway(int* nvtxs,
                            idxtype* xadj,
                            idxtype* adjncy,
                            idxtype* vwgt,
                            idxtype* vsize,
...
void metis_wpartgraphvkaway_(int* nvtxs,
                             idxtype* xadj,
                             idxtype* adjncy,
                             idxtype* vwgt,
                             idxtype* vsize,
...
void metis_wpartgraphvkaway__(int* nvtxs,
                              idxtype* xadj,
                              idxtype* adjncy,
                              idxtype* vwgt,
                              idxtype* vsize,
