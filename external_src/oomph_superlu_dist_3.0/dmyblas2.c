...
void dlsolve(int ldm, int ncol, double* M, double* rhs)
{
  ...
  { /* Do 8 columns */
    ...
    x7 = rhs[firstcol + 7] - x0 * *Mki0++ - x1 * *Mki1++ - x2 * *Mki2++ -
         x3 * *Mki3++ - x4 * *Mki4++ - x5 * *Mki5++ - x6 * *Mki6++;
    ...
    for (k = firstcol; k < ncol; k++)
      rhs[k] = rhs[k] - x0 * *Mki0++ - x1 * *Mki1++ - x2 * *Mki2++ -
               x3 * *Mki3++ - x4 * *Mki4++ - x5 * *Mki5++ - x6 * *Mki6++ -
               x7 * *Mki7++;
  ...
  { /* Do 4 columns */
    ...
    for (k = firstcol; k < ncol; k++)
      rhs[k] =
        rhs[k] - x0 * *Mki0++ - x1 * *Mki1++ - x2 * *Mki2++ - x3 * *Mki3++;
 ...
 * </pre>
 */
void dmatvec(int ldm, /* in -- leading dimension of M */
             int nrow, /* in */
             int ncol, /* in */
             double* M, /* in */
             double* vec, /* in */
...
)
{
  ...
  { /* Do 8 columns */
    ...
    for (k = 0; k < nrow; k++)
      Mxvec[k] += vi0 * *Mki0++ + vi1 * *Mki1++ + vi2 * *Mki2++ +
                  vi3 * *Mki3++ + vi4 * *Mki4++ + vi5 * *Mki5++ +
                  vi6 * *Mki6++ + vi7 * *Mki7++;
