...
/* Subroutine */ int genmmd_dist_(int_t* neqns,
                                  int_t* xadj,
                                  int_t* adjncy,
                                  int_t* invp,
                                  int_t* perm,
                                  ...
                                  int_t* nofsub)
{
  ...
  extern /* Subroutine */ int mmdelm_dist(int_t*,
                                          int_t*,
                                          int_t*,
                                          int_t*,
                                          int_t*,
...
/* Subroutine */ int mmdint_dist(int_t* neqns,
                                 int_t* xadj,
                                 int_t* adjncy,
                                 int_t* dhead,
                                 int_t* dforw,
...
/* Subroutine */ int mmdelm_dist(int_t* mdnode,
                                 int_t* xadj,
                                 int_t* adjncy,
                                 int_t* dhead,
                                 int_t* dforw,
                                 ...
                                 int_t* tag)
{
  ...
  /* Local variables */
  static int_t node, link, rloc, rlmt, i, j, nabor, rnode, elmnt, xqnbr, istop,
    jstop, istrt, jstrt, nxnode, pvnode, nqnbrs, npv;
...
/* Subroutine */ int mmdupd_dist(int_t* ehead,
                                 int_t* neqns,
                                 int_t* xadj,
                                 int_t* adjncy,
                                 int_t* delta,
                                 ...
                                 int_t* tag)
{
  ...
  /* Local variables */
  static int_t node, mtag, link, mdeg0, i, j, enode, fnode, nabor, elmnt, istop,
    jstop, q2head, istrt, jstrt, qxhead, iq2, deg, deg0;
...
/* Subroutine */ int mmdnum_dist(int_t* neqns,
                                 int_t* perm,
                                 int_t* invp,
                                 int_t* qsize)
{
