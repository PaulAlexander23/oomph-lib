...
extern "C"
{
  ...
  extern void sp_colorder(
    superlu_options_t*, SuperMatrix*, int_t*, int_t*, SuperMatrix*);
  extern int_t sp_coletree_dist(int_t*, int_t*, int_t*, int_t, int_t, int_t*);
  extern void countnz_dist(
    const int_t, int_t*, int_t*, int_t*, Glu_persist_t*, Glu_freeable_t*);
  extern int_t fixupL_dist(const int_t,
                           const int_t*,
                           Glu_persist_t*,
                           Glu_freeable_t*);
  ...
  extern void ScalePermstructInit(const int_t, const int_t, ScalePermstruct_t*);
  extern void ScalePermstructFree(ScalePermstruct_t*);
  extern void superlu_gridinit(MPI_Comm, int_t, int_t, gridinfo_t*);
  extern void superlu_gridmap(
    MPI_Comm, int_t, int_t, int_t[], int_t, gridinfo_t*);
  extern void superlu_gridexit(gridinfo_t*);
  extern void get_perm_c_dist(int_t, int_t, SuperMatrix*, int_t*);
  extern void a_plus_at_dist(
    const int_t, const int_t, int_t*, int_t*, int_t*, int_t**, int_t**);
  extern void bcast_tree(
    void*, int, MPI_Datatype, int, int, gridinfo_t*, int, int*);
  extern int_t symbfact(superlu_options_t*,
                        int,
                        SuperMatrix*,
                        int_t*,
                        int_t*,
                        Glu_persist_t*,
                        Glu_freeable_t*);
  extern int_t symbfact_SubInit(
    fact_t, void*, int_t, int_t, int_t, int_t, Glu_persist_t*, Glu_freeable_t*);
  extern int_t symbfact_SubXpand(
    int_t, int_t, int_t, MemType, int_t*, Glu_freeable_t*);
  extern int_t symbfact_SubFree(Glu_freeable_t*);
  extern void get_diag_procs(
    int_t, Glu_persist_t*, gridinfo_t*, int_t*, int_t**, int_t**);
  ...
  extern float symbfact_dist(int,
                             int,
                             SuperMatrix*,
                             int_t*,
                             int_t*,
  ...
  extern float get_perm_c_parmetis(SuperMatrix*,
                                   int_t*,
                                   int_t*,
                                   int,
                                   int,
  ...
  extern int_t psymbfact_LUXpandMem(int_t,
                                    int_t,
                                    int_t,
                                    int_t,
                                    int_t,
  ...
  extern int_t psymbfact_LUXpand(int_t,
                                 int_t,
                                 int_t,
                                 int_t,
                                 int_t*,
  ...
  extern int_t psymbfact_LUXpand_RL(int_t,
                                    int_t,
                                    int_t,
                                    int_t,
                                    int_t,
  ...
  extern int_t psymbfact_prLUXpand(
    int_t, int_t, MemType, Llu_symbfact_t*, psymbfact_stat_t*);
