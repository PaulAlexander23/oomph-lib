...
namespace oomph
{
  ...
  public:
    ...
    // Data* get_geom_data_pt(const unsigned& n)
    //{
    //  return this->geom_data_pt(PerturbedSpine_geometric_index[n]);
    //}

    // Data* get_perturbedspine_data_pt(const unsigned& n)
    //{
    ...
    //  return perturbedspine_pt->height_pt();
    //}
  ...
  public:
    ...
    unsigned long assign_global_perturbed_spine_eqn_numbers(
