...
/* 04/05/2006 (KMCCARTY): add gFortran symbol here */
  ...
  defined(__INTEL_COMPILER) || defined(INTEL_COMPILER) || defined(gFortran)
#define f2cFortran
#endif
...
#define initfstr(F, C, ELEMNO, ELEMLEN) \
  ((F).dsc$l_arsize = ((F).dsc$w_length = (ELEMLEN)) * \
   ...
   (F).dsc$a_a0 = ((F).dsc$a_pointer = (C)) - (F).dsc$w_length, \
   (F))
...
#define FCB2CSTR(FSTR, CSTR, DIM) \
  vkill_trailing(f2cstrv((char*)FSTR, \
                         (char*)CSTR, \
                         sizeof(FSTR) / cfelementsof(FSTR, DIM) + 1, \
                         sizeof(FSTR) + cfelementsof(FSTR, DIM)), \
                 sizeof(FSTR) / cfelementsof(FSTR, DIM) + 1, \
...
#define STRINGV_cfA(M, I, A, B) \
  AATRINGV_cfA( \
    (char*)A, B, sizeof(A), firstindexlength(A), secondindexlength(A))
...
#define PSTRINGV_cfW(A, B) \
  vkill_trailing( \
    f2cstrv( \
      (char*)A, (char*)A, B.dsc$w_length + 1, B.dsc$l_arsize + B.dsc$l_m[0]), \
    B.dsc$w_length + 1, \
    ...
    F(T8, 8, 1) F(T9, 9, 1) F(TA, 10, 1) F(TB, 11, 1) F(TC, 12, 1) \
      F(TD, 13, 1) F(TE, 14, 1) F(TF, 15, 1) F(TG, 16, 1) F(TH, 17, 1) \
        F(TI, 18, 1) F(TJ, 19, 1) F(TK, 20, 1) F(TL, 21, 1) F(TM, 22, 1) \
          F(TN, 23, 1) F(TO, 24, 1) F(TP, 25, 1) F(TQ, 26, 1) F(TR, 27, 1) M \
          CFARGT27S(S, \
                    T1, \
                    T2, \
                    T3, \
...
#define CFARGT20(F, \
  ...
  F(T2, 2, 1) F(T3, 3, 1) F(T4, 4, 1) F(T5, 5, 1) F(T6, 6, 1) F(T7, 7, 1) \
    F(T8, 8, 1) F(T9, 9, 1) F(TA, 10, 1) F(TB, 11, 1) F(TC, 12, 1) \
      F(TD, 13, 1) F(TE, 14, 1) F(TF, 15, 1) F(TG, 16, 1) F(TH, 17, 1) \
        F(TI, 18, 1) F(TJ, 19, 1) F(TK, 20, 1) S(T1, 1) S(T2, 2) S(T3, 3) \
          S(T4, 4) S(T5, 5) S(T6, 6) S(T7, 7) S(T8, 8) S(T9, 9) S(TA, 10) \
  ...
  F(T2, A2, 2, 1) F(T3, A3, 3, 1) F(T4, A4, 4, 1) F(T5, A5, 5, 1) \
    F(T6, A6, 6, 1) F(T7, A7, 7, 1) F(T8, A8, 8, 1) F(T9, A9, 9, 1) \
      F(TA, AA, 10, 1) F(TB, AB, 11, 1) F(TC, AC, 12, 1) F(TD, AD, 13, 1) \
        F(TE, AE, 14, 1) S(T1, 1) S(T2, 2) S(T3, 3) S(T4, 4) S(T5, 5) S(T6, 6) \
          S(T7, 7) S(T8, 8) S(T9, 9) S(TA, 10) S(TB, 11) S(TC, 12) S(TD, 13) \
            S(TE, 14)
    ...
    F(T6, A6, 6, 1) F(T7, A7, 7, 1) F(T8, A8, 8, 1) F(T9, A9, 9, 1) \
      F(TA, AA, 10, 1) F(TB, AB, 11, 1) F(TC, AC, 12, 1) F(TD, AD, 13, 1) \
        F(TE, AE, 14, 1) F(TF, AF, 15, 1) F(TG, AG, 16, 1) F(TH, AH, 17, 1) \
          F(TI, AI, 18, 1) F(TJ, AJ, 19, 1) F(TK, AK, 20, 1) S(T1, 1) S(T2, 2) \
            S(T3, 3) S(T4, 4) S(T5, 5) S(T6, 6) S(T7, 7) S(T8, 8) S(T9, 9) \
              S(TA, 10) S(TB, 11) S(TC, 12) S(TD, 13) S(TE, 14) S(TF, 15) \
                S(TG, 16) S(TH, 17) S(TI, 18) S(TJ, 19) S(TK, 20)
#define CFARGTA27(F, \
                  S, \
                  T1, \
                  T2, \
  ...
  F(T2, A2, 2, 1) F(T3, A3, 3, 1) F(T4, A4, 4, 1) F(T5, A5, 5, 1) \
    F(T6, A6, 6, 1) F(T7, A7, 7, 1) F(T8, A8, 8, 1) F(T9, A9, 9, 1) \
      F(TA, AA, 10, 1) F(TB, AB, 11, 1) F(TC, AC, 12, 1) F(TD, AD, 13, 1) \
        F(TE, AE, 14, 1) F(TF, AF, 15, 1) F(TG, AG, 16, 1) F(TH, AH, 17, 1) \
          F(TI, AI, 18, 1) F(TJ, AJ, 19, 1) F(TK, AK, 20, 1) F(TL, AL, 21, 1) \
            F(TM, AM, 22, 1) F(TN, AN, 23, 1) F(TO, AO, 24, 1) \
              F(TP, AP, 25, 1) F(TQ, AQ, 26, 1) F(TR, AR, 27, 1) S(T1, 1) \
                S(T2, 2) S(T3, 3) S(T4, 4) S(T5, 5) S(T6, 6) S(T7, 7) S(T8, 8) \
                  S(T9, 9) S(TA, 10) S(TB, 11) S(TC, 12) S(TD, 13) S(TE, 14) \
                    S(TF, 15) S(TG, 16) S(TH, 17) S(TI, 18) S(TJ, 19) \
                      S(TK, 20) S(TL, 21) S(TM, 22) S(TN, 23) S(TO, 24) \
                        S(TP, 25) S(TQ, 26) S(TR, 27)
#endif
#else
#define CFARGT14( \
  F, S, M, T1, T2, T3, T4, T5, T6, T7, T8, T9, TA, TB, TC, TD, TE) \
  ...
  S(T1, 1) F(T2, 2, 1) S(T2, 2) F(T3, 3, 1) S(T3, 3) F(T4, 4, 1) S(T4, 4) \
    F(T5, 5, 1) S(T5, 5) F(T6, 6, 1) S(T6, 6) F(T7, 7, 1) S(T7, 7) F(T8, 8, 1) \
      S(T8, 8) F(T9, 9, 1) S(T9, 9) F(TA, 10, 1) S(TA, 10) F(TB, 11, 1) \
        S(TB, 11) F(TC, 12, 1) S(TC, 12) F(TD, 13, 1) S(TD, 13) F(TE, 14, 1) \
          S(TE, 14)
#define CFARGT27(F, \
                 S, \
                 M, \
  ...
  S(T1, 1) F(T2, 2, 1) S(T2, 2) F(T3, 3, 1) S(T3, 3) F(T4, 4, 1) S(T4, 4) \
    F(T5, 5, 1) S(T5, 5) F(T6, 6, 1) S(T6, 6) F(T7, 7, 1) S(T7, 7) F(T8, 8, 1) \
      S(T8, 8) F(T9, 9, 1) S(T9, 9) F(TA, 10, 1) S(TA, 10) F(TB, 11, 1) \
        S(TB, 11) F(TC, 12, 1) S(TC, 12) F(TD, 13, 1) S(TD, 13) F(TE, 14, 1) \
          S(TE, 14) F(TF, 15, 1) S(TF, 15) F(TG, 16, 1) S(TG, 16) F(TH, 17, 1) \
            S(TH, 17) F(TI, 18, 1) S(TI, 18) F(TJ, 19, 1) S(TJ, 19) \
              F(TK, 20, 1) S(TK, 20) F(TL, 21, 1) S(TL, 21) F(TM, 22, 1) \
                S(TM, 22) F(TN, 23, 1) S(TN, 23) F(TO, 24, 1) S(TO, 24) \
                  F(TP, 25, 1) S(TP, 25) F(TQ, 26, 1) S(TQ, 26) F(TR, 27, 1) \
                    S(TR, 27)
...
#define CFARGTA14(F, \
  ...
  S(T1, 1) F(T2, A2, 2, 1) S(T2, 2) F(T3, A3, 3, 1) S(T3, 3) F(T4, A4, 4, 1) \
    S(T4, 4) F(T5, A5, 5, 1) S(T5, 5) F(T6, A6, 6, 1) S(T6, 6) F(T7, A7, 7, 1) \
      S(T7, 7) F(T8, A8, 8, 1) S(T8, 8) F(T9, A9, 9, 1) S(T9, 9) \
        F(TA, AA, 10, 1) S(TA, 10) F(TB, AB, 11, 1) S(TB, 11) F(TC, AC, 12, 1) \
          S(TC, 12) F(TD, AD, 13, 1) S(TD, 13) F(TE, AE, 14, 1) S(TE, 14)
#if MAX_PREPRO_ARGS > 31
#define CFARGTA20(F, \
                  S, \
                  T1, \
  ...
  S(T1, 1) F(T2, A2, 2, 1) S(T2, 2) F(T3, A3, 3, 1) S(T3, 3) F(T4, A4, 4, 1) \
    S(T4, 4) F(T5, A5, 5, 1) S(T5, 5) F(T6, A6, 6, 1) S(T6, 6) F(T7, A7, 7, 1) \
      S(T7, 7) F(T8, A8, 8, 1) S(T8, 8) F(T9, A9, 9, 1) S(T9, 9) \
        F(TA, AA, 10, 1) S(TA, 10) F(TB, AB, 11, 1) S(TB, 11) F(TC, AC, 12, 1) \
          S(TC, 12) F(TD, AD, 13, 1) S(TD, 13) F(TE, AE, 14, 1) S(TE, 14) \
            F(TF, AF, 15, 1) S(TF, 15) F(TG, AG, 16, 1) S(TG, 16) \
              F(TH, AH, 17, 1) S(TH, 17) F(TI, AI, 18, 1) S(TI, 18) \
        ...
        F(TA, AA, 10, 1) S(TA, 10) F(TB, AB, 11, 1) S(TB, 11) F(TC, AC, 12, 1) \
          S(TC, 12) F(TD, AD, 13, 1) S(TD, 13) F(TE, AE, 14, 1) S(TE, 14) \
            F(TF, AF, 15, 1) S(TF, 15) F(TG, AG, 16, 1) S(TG, 16) \
              F(TH, AH, 17, 1) S(TH, 17) F(TI, AI, 18, 1) S(TI, 18) \
                F(TJ, AJ, 19, 1) S(TJ, 19) F(TK, AK, 20, 1) S(TK, 20) \
                  F(TL, AL, 21, 1) S(TL, 21) F(TM, AM, 22, 1) S(TM, 22) \
                    F(TN, AN, 23, 1) S(TN, 23) F(TO, AO, 24, 1) S(TO, 24) \
                      F(TP, AP, 25, 1) S(TP, 25) F(TQ, AQ, 26, 1) S(TQ, 26) \
                        F(TR, AR, 27, 1) S(TR, 27)
#endif
#endif


#define PROTOCCALLSFSUB1(UN, LN, T1) \
  PROTOCCALLSFSUB14(UN, \
                    LN, \
                    T1, \
                    CF_0, \
                    CF_0, \
...
#define PROTOCCALLSFSUB9(UN, LN, T1, T2, T3, T4, T5, T6, T7, T8, T9) \
  PROTOCCALLSFSUB14( \
    UN, LN, T1, T2, T3, T4, T5, T6, T7, T8, T9, CF_0, CF_0, CF_0, CF_0, CF_0)
#define PROTOCCALLSFSUB10(UN, LN, T1, T2, T3, T4, T5, T6, T7, T8, T9, TA) \
  PROTOCCALLSFSUB14( \
    UN, LN, T1, T2, T3, T4, T5, T6, T7, T8, T9, TA, CF_0, CF_0, CF_0, CF_0)
#define PROTOCCALLSFSUB11(UN, LN, T1, T2, T3, T4, T5, T6, T7, T8, T9, TA, TB) \
  PROTOCCALLSFSUB14( \
    UN, LN, T1, T2, T3, T4, T5, T6, T7, T8, T9, TA, TB, CF_0, CF_0, CF_0)
#define PROTOCCALLSFSUB12( \
  UN, LN, T1, T2, T3, T4, T5, T6, T7, T8, T9, TA, TB, TC) \
  PROTOCCALLSFSUB14( \
    UN, LN, T1, T2, T3, T4, T5, T6, T7, T8, T9, TA, TB, TC, CF_0, CF_0)
#define PROTOCCALLSFSUB13( \
  UN, LN, T1, T2, T3, T4, T5, T6, T7, T8, T9, TA, TB, TC, TD) \
  PROTOCCALLSFSUB14( \
    UN, LN, T1, T2, T3, T4, T5, T6, T7, T8, T9, TA, TB, TC, TD, CF_0)


#define PROTOCCALLSFSUB15( \
  UN, LN, T1, T2, T3, T4, T5, T6, T7, T8, T9, TA, TB, TC, TD, TE, TF) \
  PROTOCCALLSFSUB20(UN, \
                    LN, \
                    T1, \
                    T2, \
                    T3, \
...
#define PROTOCCALLSFSUB16( \
  UN, LN, T1, T2, T3, T4, T5, T6, T7, T8, T9, TA, TB, TC, TD, TE, TF, TG) \
  PROTOCCALLSFSUB20(UN, \
                    LN, \
                    T1, \
                    T2, \
...
#define PROTOCCALLSFSUB17( \
  UN, LN, T1, T2, T3, T4, T5, T6, T7, T8, T9, TA, TB, TC, TD, TE, TF, TG, TH) \
  PROTOCCALLSFSUB20(UN, \
                    LN, \
                    T1, \
                    T2, \
...
#define PROTOCCALLSFSUB14( \
  UN, LN, T1, T2, T3, T4, T5, T6, T7, T8, T9, TA, TB, TC, TD, TE) \
  PROTOCCALLSFFUN14( \
    VOID, UN, LN, T1, T2, T3, T4, T5, T6, T7, T8, T9, TA, TB, TC, TD, TE)
...
#define PROTOCCALLSFSUB14( \
  ...
  _(VOID, _cfPU) \
  (CFC_(UN, LN))(CFARGT14( \
    NCF, KCF, _Z, T1, T2, T3, T4, T5, T6, T7, T8, T9, TA, TB, TC, TD, TE));
#define PROTOCCALLSFSUB20(UN, \
                          LN, \
                          T1, \
                          T2, \
...
#define CCALLSFSUB6(UN, LN, T1, T2, T3, T4, T5, T6, A1, A2, A3, A4, A5, A6) \
  CCALLSFSUB10(UN, \
               ...
               0)
#define CCALLSFSUB7( \
  UN, LN, T1, T2, T3, T4, T5, T6, T7, A1, A2, A3, A4, A5, A6, A7) \
  CCALLSFSUB10(UN, \
               LN, \
               T1, \
               T2, \
               ...
               0)
#define CCALLSFSUB8( \
  UN, LN, T1, T2, T3, T4, T5, T6, T7, T8, A1, A2, A3, A4, A5, A6, A7, A8) \
  CCALLSFSUB10(UN, \
               LN, \
               T1, \
               T2, \
...
#define CCALLSFSUB14(UN, \
  ...
  { \
        ...
        VVCF(TA, AA, B10) VVCF(TB, AB, B11) VVCF(TC, AC, B12) \
          VVCF(TD, AD, B13) VVCF(TE, AE, B14) CPPPROTOCLSFSUB14( \
            ...
            ACF(LN, T1, A1, 1) ACF(LN, T2, A2, 2) ACF(LN, T3, A3, 3) \
              ACF(LN, T4, A4, 4) ACF(LN, T5, A5, 5) ACF(LN, T6, A6, 6) \
                ACF(LN, T7, A7, 7) ACF(LN, T8, A8, 8) ACF(LN, T9, A9, 9) \
                  ACF(LN, TA, AA, 10) ACF(LN, TB, AB, 11) ACF(LN, TC, AC, 12) \
                    ACF(LN, TD, AD, 13) ACF(LN, TE, AE, 14) CFC_(UN, LN)( \
                      CFARGTA14(AACF, \
                                JCF, \
                                T1, \
                                T2, \
    ...
    WCF(T2, A2, 2) WCF(T3, A3, 3) WCF(T4, A4, 4) WCF(T5, A5, 5) WCF(T6, A6, 6) \
      WCF(T7, A7, 7) WCF(T8, A8, 8) WCF(T9, A9, 9) WCF(TA, AA, 10) \
        WCF(TB, AB, 11) WCF(TC, AC, 12) WCF(TD, AD, 13) WCF(TE, AE, 14) \
  } while (0)
#endif
...
#define CCALLSFSUB20(UN, \
  ...
  { \
    ...
    VVCF(T2, A2, B2) VVCF(T3, A3, B3) VVCF(T4, A4, B4) VVCF(T5, A5, B5) \
      VVCF(T6, A6, B6) VVCF(T7, A7, B7) VVCF(T8, A8, B8) VVCF(T9, A9, B9) \
        VVCF(TA, AA, B10) VVCF(TB, AB, B11) VVCF(TC, AC, B12) \
          VVCF(TD, AD, B13) VVCF(TE, AE, B14) VVCF(TF, AF, B15) \
            VVCF(TG, AG, B16) VVCF(TH, AH, B17) VVCF(TI, AI, B18) \
              VVCF(TJ, AJ, B19) VVCF(TK, AK, B20) \
                CPPPROTOCLSFSUB20(UN, \
                                  LN, \
                                  T1, \
                                  T2, \
                                  T3, \
                  ...
                  ACF(LN, T3, A3, 3) ACF(LN, T4, A4, 4) ACF(LN, T5, A5, 5) \
                    ACF(LN, T6, A6, 6) ACF(LN, T7, A7, 7) ACF(LN, T8, A8, 8) \
                      ACF(LN, T9, A9, 9) ACF(LN, TA, AA, 10) \
                        ACF(LN, TB, AB, 11) ACF(LN, TC, AC, 12) \
                          ACF(LN, TD, AD, 13) ACF(LN, TE, AE, 14) \
                            ACF(LN, TF, AF, 15) ACF(LN, TG, AG, 16) \
                              ACF(LN, TH, AH, 17) ACF(LN, TI, AI, 18) \
                                ACF(LN, TJ, AJ, 19) ACF(LN, TK, AK, 20) CFC_( \
                                  UN, LN)(CFARGTA20(AACF, \
                                                    JCF, \
                                                    T1, \
                                                    T2, \
                                                    T3, \
    ...
    WCF(T2, A2, 2) WCF(T3, A3, 3) WCF(T4, A4, 4) WCF(T5, A5, 5) WCF(T6, A6, 6) \
      WCF(T7, A7, 7) WCF(T8, A8, 8) WCF(T9, A9, 9) WCF(TA, AA, 10) \
        WCF(TB, AB, 11) WCF(TC, AC, 12) WCF(TD, AD, 13) WCF(TE, AE, 14) \
          WCF(TF, AF, 15) WCF(TG, AG, 16) WCF(TH, AH, 17) WCF(TI, AI, 18) \
            WCF(TJ, AJ, 19) WCF(TK, AK, 20) \
  } while (0)
#endif
  ...
  { \
    ...
    VVCF(T2, A2, B2) VVCF(T3, A3, B3) VVCF(T4, A4, B4) VVCF(T5, A5, B5) \
      VVCF(T6, A6, B6) VVCF(T7, A7, B7) VVCF(T8, A8, B8) VVCF(T9, A9, B9) \
        VVCF(TA, AA, B10) VVCF(TB, AB, B11) VVCF(TC, AC, B12) \
          VVCF(TD, AD, B13) VVCF(TE, AE, B14) VVCF(TF, AF, B15) \
            VVCF(TG, AG, B16) VVCF(TH, AH, B17) VVCF(TI, AI, B18) \
              VVCF(TJ, AJ, B19) VVCF(TK, AK, B20) VVCF(TL, AL, B21) \
                VVCF(TM, AM, B22) VVCF(TN, AN, B23) VVCF(TO, AO, B24) \
                  VVCF(TP, AP, B25) VVCF(TQ, AQ, B26) VVCF( \
                    TR, AR, B27) CPPPROTOCLSFSUB27(UN, \
                                                   LN, \
                                                   T1, \
                                                   T2, \
                                                   T3, \
                                                   ...
                                                   TQ, \
                                                   TR) ACF(LN, T1, A1, 1) \
                    ACF(LN, T2, A2, 2) ACF(LN, T3, A3, 3) ACF(LN, T4, A4, 4) \
                      ACF(LN, T5, A5, 5) ACF(LN, T6, A6, 6) ACF(LN, T7, A7, 7) \
                        ACF(LN, T8, A8, 8) ACF(LN, T9, A9, 9) \
                          ACF(LN, TA, AA, 10) ACF(LN, TB, AB, 11) \
                            ACF(LN, TC, AC, 12) ACF(LN, TD, AD, 13) \
                              ACF(LN, TE, AE, 14) ACF(LN, TF, AF, 15) \
                                ACF(LN, TG, AG, 16) ACF(LN, TH, AH, 17) \
                                  ACF(LN, TI, AI, 18) ACF(LN, TJ, AJ, 19) \
                                    ACF(LN, TK, AK, 20) ACF(LN, TL, AL, 21) \
                                      ACF(LN, TM, AM, 22) ACF(LN, TN, AN, 23) \
                                        ACF(LN, TO, AO, 24) \
                                          ACF(LN, TP, AP, 25) \
                                            ACF(LN, TQ, AQ, 26) \
                                              ACF(LN, TR, AR, 27) CFC_( \
                                                UN, LN)(CFARGTA27(AACF, \
                                                                  JCF, \
                                                                  T1, \
                                                                  T2, \
                                                                  T3, \
    ...
    WCF(T2, A2, 2) WCF(T3, A3, 3) WCF(T4, A4, 4) WCF(T5, A5, 5) WCF(T6, A6, 6) \
      WCF(T7, A7, 7) WCF(T8, A8, 8) WCF(T9, A9, 9) WCF(TA, AA, 10) \
        WCF(TB, AB, 11) WCF(TC, AC, 12) WCF(TD, AD, 13) WCF(TE, AE, 14) \
          WCF(TF, AF, 15) WCF(TG, AG, 16) WCF(TH, AH, 17) WCF(TI, AI, 18) \
            WCF(TJ, AJ, 19) WCF(TK, AK, 20) WCF(TL, AL, 21) WCF(TM, AM, 22) \
              WCF(TN, AN, 23) WCF(TO, AO, 24) WCF(TP, AP, 25) WCF(TQ, AQ, 26) \
                WCF(TR, AR, 27) \
  } while (0)
#endif
#endif /* MAX_PREPRO_ARGS */
...
#define PSTRING_cfC(M, I, A, B, C) \
  (B.dsc$a_pointer = A, \
   C == sizeof(char*) ? \
     ...
     (A[C - 1] = '\0', \
      B.dsc$w_length = strlen(A), \
      memset((A) + B.dsc$w_length, ' ', C - B.dsc$w_length - 1), \
      B.dsc$w_length = C - 1));
#else
#define STRING_cfC(M, I, A, B, C) \
  (B.nombre = A, \
   ...
   C == sizeof(char*) || C == (unsigned)(B.clen + 1) ? \
     B.flen = B.clen : \
     (memset(B.nombre + B.clen, ' ', C - B.clen - 1), \
...
#define CCALLSFFUN14(UN, \
                     ...
                     AD, \
                     AE) \
  ((CFFUN(UN)(BCF(T1, A1, 0) BCF(T2, A2, 1) BCF(T3, A3, 1) BCF(T4, A4, 1) BCF( \
    T5, A5, 1) BCF(T6, A6, 1) BCF(T7, A7, 1) BCF(T8, A8, 1) BCF(T9, A9, 1) \
                BCF(TA, AA, 1) BCF(TB, AB, 1) BCF(TC, AC, 1) BCF(TD, AD, 1) \
                  BCF(TE, AE, 1) SCF(T1, LN, 1, A1) SCF(T2, LN, 2, A2) \
...
#define PROTOCCALLSFFUN5(T0, UN, LN, T1, T2, T3, T4, T5) \
  PROTOCCALLSFFUN10( \
    T0, UN, LN, T1, T2, T3, T4, T5, CF_0, CF_0, CF_0, CF_0, CF_0)
...
#define PROTOCCALLSFFUN10(T0, UN, LN, T1, T2, T3, T4, T5, T6, T7, T8, T9, TA) \
  PROTOCCALLSFFUN14(T0, \
                    ...
                    CF_0, \
                    CF_0)
#define PROTOCCALLSFFUN11( \
  T0, UN, LN, T1, T2, T3, T4, T5, T6, T7, T8, T9, TA, TB) \
  PROTOCCALLSFFUN14( \
    T0, UN, LN, T1, T2, T3, T4, T5, T6, T7, T8, T9, TA, TB, CF_0, CF_0, CF_0)
#define PROTOCCALLSFFUN12( \
  T0, UN, LN, T1, T2, T3, T4, T5, T6, T7, T8, T9, TA, TB, TC) \
  PROTOCCALLSFFUN14( \
    T0, UN, LN, T1, T2, T3, T4, T5, T6, T7, T8, T9, TA, TB, TC, CF_0, CF_0)
#define PROTOCCALLSFFUN13( \
  T0, UN, LN, T1, T2, T3, T4, T5, T6, T7, T8, T9, TA, TB, TC, TD) \
  PROTOCCALLSFFUN14( \
    T0, UN, LN, T1, T2, T3, T4, T5, T6, T7, T8, T9, TA, TB, TC, TD, CF_0)

/* HP/UX 9.01 cc requires the blank between '_Icf(3,G,T0,UN,LN) CCCF(T1,1,0)' */

#ifndef __CF__KnR
#define PROTOCCALLSFFUN14( \
  T0, UN, LN, T1, T2, T3, T4, T5, T6, T7, T8, T9, TA, TB, TC, TD, TE) \
 ...
 CFARGT14(CCCF,JCF,ABSOFT_cf1(T0),T1,T2,T3,T4,T5,T6,T7,T8,T9,TA,TB,TC,TD,TE)); \
    ...
    WCF(T2, A2, 2) WCF(T3, A3, 3) WCF(T4, A4, 4) WCF(T5, A5, 5) WCF(T6, A6, 6) \
      WCF(T7, A7, 7) WCF(T8, A8, 8) WCF(T9, A9, 9) WCF(TA, A10, 10) \
        WCF(TB, A11, 11) WCF(TC, A12, 12) WCF(TD, A13, 13) WCF(TE, A14, 14) \
          _(T0, _cfX) \
  }
#else
#define PROTOCCALLSFFUN14( \
...
#define TTTTSTRV(A, B, D, E) \
  (_(B, N) = E, \
   B = _cf_malloc(_(B, N) * (D + 1)), \
   (void*)vkill_trailing( \
     f2cstrv(A, B, D + 1, _(B, N) * (D + 1)), D + 1, _(B, N) * (D + 1), ' '))
#ifdef vmsFortran
...
#define STRING_cfK \
  memcpy( \
    _fcdtocp(AS), A0, _cfMIN(_fcdlen(AS), (A0 == NULL ? 0 : strlen(A0)))); \
...
#define FCALLSCSUB12( \
  CN, UN, LN, T1, T2, T3, T4, T5, T6, T7, T8, T9, TA, TB, TC) \
  FCALLSCFUN12(VOID, CN, UN, LN, T1, T2, T3, T4, T5, T6, T7, T8, T9, TA, TB, TC)
#define FCALLSCSUB13( \
  CN, UN, LN, T1, T2, T3, T4, T5, T6, T7, T8, T9, TA, TB, TC, TD) \
  FCALLSCFUN13( \
    VOID, CN, UN, LN, T1, T2, T3, T4, T5, T6, T7, T8, T9, TA, TB, TC, TD)
#define FCALLSCSUB14( \
  CN, UN, LN, T1, T2, T3, T4, T5, T6, T7, T8, T9, TA, TB, TC, TD, TE) \
  FCALLSCFUN14( \
    VOID, CN, UN, LN, T1, T2, T3, T4, T5, T6, T7, T8, T9, TA, TB, TC, TD, TE)
#define FCALLSCSUB15( \
  CN, UN, LN, T1, T2, T3, T4, T5, T6, T7, T8, T9, TA, TB, TC, TD, TE, TF) \
  FCALLSCFUN15(VOID, \
               CN, \
               UN, \
               LN, \
               ...
               TF)
#define FCALLSCSUB16( \
  CN, UN, LN, T1, T2, T3, T4, T5, T6, T7, T8, T9, TA, TB, TC, TD, TE, TF, TG) \
  FCALLSCFUN16(VOID, \
               CN, \
               UN, \
               LN, \
...
#define FCALLSCFUN10(T0, CN, UN, LN, T1, T2, T3, T4, T5, T6, T7, T8, T9, TA) \
  FCALLSCFUN14(T0, \
               ...
               CF_0)
#define FCALLSCFUN11( \
  T0, CN, UN, LN, T1, T2, T3, T4, T5, T6, T7, T8, T9, TA, TB) \
  FCALLSCFUN14(T0, \
               CN, \
               UN, \
               LN, \
               ...
               CF_0)
#define FCALLSCFUN12( \
  T0, CN, UN, LN, T1, T2, T3, T4, T5, T6, T7, T8, T9, TA, TB, TC) \
  FCALLSCFUN14(T0, \
               CN, \
               UN, \
               LN, \
               ...
               CF_0)
#define FCALLSCFUN13( \
  T0, CN, UN, LN, T1, T2, T3, T4, T5, T6, T7, T8, T9, TA, TB, TC, TD) \
  FCALLSCFUN14( \
    T0, CN, UN, LN, T1, T2, T3, T4, T5, T6, T7, T8, T9, TA, TB, TC, TD, CF_0)


#define FCALLSCFUN15( \
  T0, CN, UN, LN, T1, T2, T3, T4, T5, T6, T7, T8, T9, TA, TB, TC, TD, TE, TF) \
  FCALLSCFUN20(T0, \
               CN, \
               UN, \
               LN, \
...
#define FCALLSCFUN14( \
  T0, CN, UN, LN, T1, T2, T3, T4, T5, T6, T7, T8, T9, TA, TB, TC, TD, TE) \
 ...
 CFARGT14(NCF,DCF,ABSOFT_cf2(T0),T1,T2,T3,T4,T5,T6,T7,T8,T9,TA,TB,TC,TD,TE) ) \
  { \
    ...
    _Icf(2, UU, T0, A0, 0); \
    _Icf(0, L, T0, 0, 0) \
      CN(TCF(LN, T1, 1, 0) TCF(LN, T2, 2, 1) TCF(LN, T3, 3, 1) \
...
#define FCALLSCFUN27(T0, \
 ...
 CFARGT27(NCF,DCF,ABSOFT_cf2(T0),T1,T2,T3,T4,T5,T6,T7,T8,T9,TA,TB,TC,TD,TE,TF,TG,TH,TI,TJ,TK,TL,TM,TN,TO,TP,TQ,TR) ) \
  { \
    ...
    _Icf(2, UU, T0, A0, 0); \
    _Icf(0, L, T0, 0, 0) CN( \
      TCF(LN, T1, 1, 0) TCF(LN, T2, 2, 1) TCF(LN, T3, 3, 1) TCF(LN, T4, 4, 1) \
        TCF(LN, T5, 5, 1) TCF(LN, T6, 6, 1) TCF(LN, T7, 7, 1) \
          TCF(LN, T8, 8, 1) TCF(LN, T9, 9, 1) TCF(LN, TA, 10, 1) \
            TCF(LN, TB, 11, 1) TCF(LN, TC, 12, 1) TCF(LN, TD, 13, 1) \
              TCF(LN, TE, 14, 1) TCF(LN, TF, 15, 1) TCF(LN, TG, 16, 1) \
                TCF(LN, TH, 17, 1) TCF(LN, TI, 18, 1) TCF(LN, TJ, 19, 1) \
                  TCF(LN, TK, 20, 1) TCF(LN, TL, 21, 1) TCF(LN, TM, 22, 1) \
                    TCF(LN, TN, 23, 1) TCF(LN, TO, 24, 1) TCF(LN, TP, 25, 1) \
                      TCF(LN, TQ, 26, 1) TCF(LN, TR, 27, 1)); \
    _Icf(0, K, T0, 0, 0) CFARGT27S(RCF, \
                                   T1, \
                                   T2, \
                                   T3, \
                                   T4, \
