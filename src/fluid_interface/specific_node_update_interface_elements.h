...
namespace oomph
{
  ...
  public:
    ...
    //   const int& face_index)
    // {
    //   // Create a temporary pointer to the appropriate FaceElement read our
    //   from
    //   // our policy class
    ...
    //   unique_additional_geom_data.begin();
  ...
  template<class EQUATION_CLASS, class DERIVATIVE_CLASS, class ELEMENT>
  class FaceGeometry<ElasticUpdateFluidInterfaceElement<EQUATION_CLASS,
                                                        DERIVATIVE_CLASS,
                                                        ELEMENT>>
  ...
  // {
  // private:
  //   /// Short Storage for the index of the Lagrange multiplier at the
  //   chosen
  //   /// nodes
