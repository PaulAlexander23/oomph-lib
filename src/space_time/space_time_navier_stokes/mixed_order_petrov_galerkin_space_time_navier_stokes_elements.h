...
namespace oomph
{
  ...
  public:
    ...
    /// x is a Vector!
    typedef void (*NavierStokesMixedOrderBodyForceFctPt)(
      const double& time, const Vector<double>& x, Vector<double>& body_force);

    /// Function pointer to source function fct(t,x) (x is a Vector!)
    typedef double (*NavierStokesMixedOrderSourceFctPt)(
  ...
  public:
    ...
    void store_reynolds_strouhal_as_external_data(
      Data* reynolds_strouhal_data_pt)
    {
#ifdef PARANOID
    ...
    /// Write values of the i_field-th scalar field at the plot points.
  ...
  public:
    ...
    QTaylorHoodMixedOrderSpaceTimeElement()
      : QElement<DIM + 1, 3>(), SpaceTimeNavierStokesMixedOrderEquations<DIM>()
    {
    }
    ...
    /// Helper function which deduce the pressure node index associated
    ...
    /// Helper function which indicates whether or not the provided
    ...
    /// DRAIG: Fill in later...
    inline void shape_u_nst(const Vector<double>& s, Shape& psi) const;
  ...
  //==========================================================================
  template<>
  inline void QTaylorHoodMixedOrderSpaceTimeElement<2>::shape_u_nst(
  ...
  //==========================================================================
  template<>
  inline void QTaylorHoodMixedOrderSpaceTimeElement<2>::dshape_local_u_nst(
    ...
    for (unsigned i = 0; i < n_node_1d; i++)
    {
      ...
      for (unsigned j = 0; j < n_node_1d; j++)
      {
        ...
        for (unsigned k = 0; k < n_node_1d; k++)
        {
          // Calculate dpsi/ds_0
          dpsidx(index, 0) =
            dpsi_values[0][k] * psi_values[1][j] * psi_values[2][i];

          // Calculate dpsi/ds_1
          dpsidx(index, 1) =
            psi_values[0][k] * dpsi_values[1][j] * psi_values[2][i];

          // Calculate dpsi/ds_2
          dpsidx(index, 2) =
            psi_values[0][k] * psi_values[1][j] * dpsi_values[2][i];
  ...
  //==========================================================================
  template<>
  inline void QTaylorHoodMixedOrderSpaceTimeElement<2>::dtest_local_u_nst(
    const Vector<double>& s, Shape& test, DShape& dtestdx) const
  {
    // Number of dimensions (3D = 2D space + 1D time)
    unsigned n_dim = 3;
    ...
    for (unsigned i = 0; i < n_node_1d; i++)
    {
      ...
      for (unsigned j = 0; j < n_node_1d; j++)
      {
        ...
        for (unsigned k = 0; k < n_node_1d; k++)
        {
          ...
          dtestdx(index, 0) =
            dtest_values[0][k] * test_values[1][j] * test_values[2][i];

          // Calculate dtest/ds_1
          dtestdx(index, 1) =
            test_values[0][k] * dtest_values[1][j] * test_values[2][i];

          // Calculate dtest/ds_2
          dtestdx(index, 2) =
            test_values[0][k] * test_values[1][j] * dtest_values[2][i];

          // Calculate the index-th entry of test
          test[index] =
            test_values[0][k] * test_values[1][j] * test_values[2][i];
  ...
  //==========================================================================
  template<unsigned DIM>
  inline double QTaylorHoodMixedOrderSpaceTimeElement<
  ...
  //==========================================================================
  template<>
  inline double QTaylorHoodMixedOrderSpaceTimeElement<2>::dpshape_eulerian(
  ...
  //==========================================================================
  template<>
  inline double QTaylorHoodMixedOrderSpaceTimeElement<2>::dptest_eulerian(
  ...
  //==========================================================================
  template<>
  inline void QTaylorHoodMixedOrderSpaceTimeElement<2>::pshape_nst(
    const Vector<double>& s, Shape& psi) const
  {
  ...
  //==========================================================================
  template<>
  inline void QTaylorHoodMixedOrderSpaceTimeElement<2>::ptest_nst(
    const Vector<double>& s, Shape& test) const
  {
    // Local storage for the shape function value (in the x-direction)
    double test1[2];
  ...
  //==========================================================================
  template<unsigned DIM>
  inline void QTaylorHoodMixedOrderSpaceTimeElement<DIM>::pshape_nst(
  ...
  template<class ELEMENT>
  class FaceGeometry<
    FaceGeometry<ProjectableTaylorHoodMixedOrderSpaceTimeElement<ELEMENT>>>
