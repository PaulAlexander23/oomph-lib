...
namespace oomph
{
  ...
  public:
                            ...
                            Vector<double>& veloc) const
    {
      ...
      for (unsigned i = 0; i < 3; i++)
      {
        ...
        {
          veloc[i] += nodal_value(l, this->u_index_nst(l, i)) * psi[l];
        }
      }
    }
    ...
    double interpolated_u_nst(const Vector<double>& s, const unsigned& i) const
    {
      ...
      for (unsigned l = 0; l < n_node; l++)
      {
        interpolated_u += nodal_value(l, this->u_index_nst(l, i)) * psi[l];
      }
                              ...
                              const unsigned& i) const
    {
      ...
      for (unsigned l = 0; l < n_node; l++)
      {
        interpolated_u += nodal_value(t, l, this->u_index_nst(l, i)) * psi[l];
      }
  ...
  public:
    ...
    {
      return nodal_value(Pconv[n_p], p_index_nst());
    }
    ...
    {
      this->node_pt(Pconv[n_p])->pin(p_index_nst());
      this->node_pt(Pconv[n_p])->set_value(p_index_nst(), pvalue);
    }
    ...
    inline int p_local_eqn(const unsigned& n) const
    {
      return nodal_local_eqn(Pconv[n], p_index_nst());
    }
