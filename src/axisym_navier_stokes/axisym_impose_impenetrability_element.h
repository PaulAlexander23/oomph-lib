...
// LIC//
// LIC//====================================================================
#ifndef OOMPH_AXISYM_IMPOSE_IMPENETRABLE_ELEMENTS_HEADER
#define OOMPH_AXISYM_IMPOSE_IMPENETRABLE_ELEMENTS_HEADER
...
namespace oomph
{
  ...
  class AxisymmetricImposeImpenetrabilityElement
  ...
  public:
    ...
    AxisymmetricImposeImpenetrabilityElement(FiniteElement* const& element_pt,
    ...
    {
      return nodal_value(j, this->u_index_axi_nst(j, i));
    }
      ...
      for (unsigned ipt = 0; ipt < n_intpt; ipt++)
      {
        ...
        for (unsigned j = 0; j < n_node; j++)
        {
            ...
            for (unsigned i = 0; i < dim_el + 1; i++)
            {
              ...
              if (flag == 1)
              {
                ...
                for (unsigned jj = 0; jj < n_node; jj++)
                {
                  ...
                  local_unknown = this->u_axi_nst_local_unknown(jj, i);
                  if (local_unknown >= 0)
                  {
          ...
          for (unsigned i = 0; i < dim_el + 1; i++)
          {
            ...
            local_eqn = this->axi_momentum_local_eqn(j, i);
  ...
  //========================================================================
  ///  SolidAxisymmetricImposeImpenetrabilityElement
  /// are elements that coincide with the faces of
  /// higher-dimensional "bulk" elements. They are used on
  ...
  //========================================================================
  template<class ELEMENT>
  class SolidAxisymmetricImposeImpenetrabilityElement
    : public virtual AxisymmetricImposeImpenetrabilityElement<ELEMENT>,
  ...
  public:
    ...
    SolidAxisymmetricImposeImpenetrabilityElement(
      ...
      const int& face_index,
      const unsigned& id = 0)
      : AxisymmetricImposeImpenetrabilityElement<ELEMENT>(
