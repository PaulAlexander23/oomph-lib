...
namespace oomph
{
  ...
  /// DIM-dimensional Hele Shaw elements with  NNODE_1D nodal points along each
  /// element edge. Inherits from TElement, HeleShawEquations and
  ...
  public:
    ...
    THeleShawElement(const THeleShawElement<NNODE_1D>& dummy) = delete;

    /// Broken assignment operator
    void operator=(const THeleShawElement<NNODE_1D>&) = delete;
