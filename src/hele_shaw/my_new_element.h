#ifndef MY_NEW_ELEMENT_HEADER
#define MY_NEW_ELEMENT_HEADER
...
namespace oomph
{
  ...
  class HeleShawWithErrorElement
    : public virtual ProjectableHeleShawElementWithSolidFaces<3>
  {
  private:
  ...
  // class ProjectableTPVDHeleShawElement
  class MyNewElement
    : public virtual ProjectableHeleShawElement<
