#ifndef MY_NEW_ELEMENT_WITH_INTEGRALS_HEADER
#define MY_NEW_ELEMENT_WITH_INTEGRALS_HEADER
...
namespace oomph
{
  ...
  template<>
  class FaceGeometry<FaceGeometry<MyNewElementWithIntegral>>
