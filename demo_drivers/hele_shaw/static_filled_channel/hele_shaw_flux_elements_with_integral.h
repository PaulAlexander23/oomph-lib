...
>>>>>>> Clean up comments.:src/hele_shaw/hele_shaw_flux_elements.h
...
>>>>>>> Clean up comments.:src/hele_shaw/hele_shaw_flux_elements.h
  ...
  class MyHeleShawFluxElement : public virtual FaceGeometry<ELEMENT>,
                                public virtual FaceElement
  {
  public:
    /// Function pointer to the prescribed-flux function fct(x,f(x)), note that
    /// x is a Vector!
    ...
    MyHeleShawFluxElement(FiniteElement* const& bulk_el_pt,
                          const int& face_index,
                          Data* const& Inlet_integral_data_pt);

<<<<<<< HEAD:demo_drivers/hele_shaw/static_filled_channel/hele_shaw_flux_elements_with_integral.h
    ///\short  Broken empty constructor
    MyHeleShawFluxElement()
=======
...
>>>>>>> Clean up comments.:src/hele_shaw/hele_shaw_flux_elements.h
    {
      throw OomphLibError(
        "Don't call empty constructor for MyHeleShawFluxElement",
        "MyHeleShawFluxElement::MyHeleShawFluxElement()",
        OOMPH_EXCEPTION_LOCATION);
    }

    /// Broken copy constructor
<<<<<<< HEAD:demo_drivers/hele_shaw/static_filled_channel/hele_shaw_flux_elements_with_integral.h
    MyHeleShawFluxElement(const MyHeleShawFluxElement& dummy)
    {
      BrokenCopy::broken_copy("MyHeleShawFluxElement");
    }

    /// Broken assignment operator
    void operator=(const MyHeleShawFluxElement&)
    {
      BrokenCopy::broken_assign("MyHeleShawFluxElement");
    }
=======
    HeleShawFluxElement(const HeleShawFluxElement& dummy) = delete;

    /// Broken assignment operator
    void operator=(const HeleShawFluxElement&) = delete;
>>>>>>> Clean up comments.:src/hele_shaw/hele_shaw_flux_elements.h
    ...
    /// Remove the external area integral data pointer
    void remove_area_data_pt();

    /// Add a external data to store the b^3 integral
    unsigned add_b3_data_pt(Data* data_pt);

    /// Remove the external b^3 integral data pointer
  ...
  protected:
    ...
    /// Function pointer to the (global) prescribed wall function
...
>>>>>>> working commit:src/hele_shaw/hele_shaw_flux_elements.h
      ...
      if (elem_pt->dim() == 3)
      {
        ...
        if (dynamic_cast<RefineableElement*>(elem_pt))
        {
          ...
          OomphLibWarning(
            ...
            "MyHeleShawFluxElement::Constructor",
            OOMPH_EXCEPTION_LOCATION);
        }
      }
    }
  ...
  //===========================================================================
  template<class ELEMENT>
  void MyHeleShawFluxElement<ELEMENT>::
    fill_in_generic_residual_contribution_poisson_flux(
      Vector<double>& residuals,
      DenseMatrix<double>& jacobian,
      const unsigned& flag)
