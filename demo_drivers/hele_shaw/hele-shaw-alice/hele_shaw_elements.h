...
namespace oomph
{
  ...
  public:
    ...
    {
      std::cout << "Bulk elements" << std::endl;
      // Call the generic routine with the flag set to 1
      fill_in_generic_residual_contribution_hele_shaw(residuals, jacobian, 1);
    }
    ...
    inline double interpolated_p_arbitrary(const Vector<double>& s,
...
namespace oomph
{
    ...
    const unsigned& flag)
  {
    ...
    const unsigned p_nodal_index = p_index_hele_shaw();
    // if (p_nodal_index==1){std::cout << p_nodal_index<< std::endl;}
