...
namespace oomph
{
  ...
  void RelaxingBubbleProblem<ELEMENT>::create_surface_polygon()
  {
    double x_center = 0.5;
    double y_center = 0.5;
    double minor_radius = (*moving_bubble::target_bubble_volume_pt) /
    ...
    Ellipse* ellipse_pt = new Ellipse(moving_bubble::major_radius, minor_radius);
  ...
  void RelaxingBubbleProblem<ELEMENT>::create_volume_constraint_mesh()
  {
    MyConstraintElement* vol_constraint_element =
      new MyConstraintElement(moving_bubble::target_fluid_volume_pt,
  ...
  void RelaxingBubbleProblem<ELEMENT>::set_variable_and_function_pointers()
  {
    ...
    for (unsigned e = 0; e < n_element; e++)
    {
      ...
      interface_element_pt->ca_inv_pt() = moving_bubble::ca_inv_pt;
      interface_element_pt->st_pt() = moving_bubble::st_pt;
      interface_element_pt->aspect_ratio_pt() = moving_bubble::alpha_pt;
  ...
  void RelaxingBubbleProblem<ELEMENT>::set_boundary_conditions()
  {
    ...
    Volume_data_pt->set_value(0, (*moving_bubble::target_fluid_volume_pt));
