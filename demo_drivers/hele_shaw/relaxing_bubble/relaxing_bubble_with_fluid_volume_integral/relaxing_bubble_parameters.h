...
namespace relaxing_bubble
{
  ...
  void doc_parameters(DocInfo& doc_info, string filename)
  {
    ...
    /// Dimensionless parameters
    output_stream << "ca_inv:" << ca_inv << endl;
    output_stream << "st:" << st << endl;
    output_stream << "alpha:" << alpha << endl;

    /// Total flux has be nondimensionalised to 1
    output_stream << "total_flux:" << total_flux << endl;
    ...
    /// Volume pointers
    output_stream << "target_bubble_volume:" << target_bubble_volume << endl;
    output_stream << "target_fluid_volume:" << target_fluid_volume << endl;
    output_stream << "total_volume:" << total_volume << endl;

    /// Pseudo-solid Poisson ratio pointer
    output_stream << "nu:" << nu << endl;
