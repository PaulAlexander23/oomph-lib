...
public:
  ...
  SelfReferentialVolumeConstraintElement* CoM_X_constraint_el_pt;
...
BubbleInChannelProblem<ELEMENT>::BubbleInChannelProblem()
{
  ...
  CoM_X_data_pt = new Data(1);
  this->add_global_data(CoM_X_data_pt);
  CoM_X_data_pt->set_value(0, initial_CoM_Y);
  Problem_Parameter::global_CoM_X_pt = CoM_X_data_pt->value_pt(0);
  CoM_X_data_pt->unpin(0);
  ...
  CoM_X_constraint_el_pt = new SelfReferentialVolumeConstraintElement(
    Problem_Parameter::global_CoM_X_pt,
    CoM_X_data_pt,
    index_of_traded_pressure);
