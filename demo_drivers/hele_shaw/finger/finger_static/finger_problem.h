...
namespace oomph
{
  ...
  FingerProblem<ELEMENT>::FingerProblem()
  {
    ...
    // cout << "Volume_mesh_pt: " << Volume_mesh_pt->ninternal_data() << endl;
    // cout << "Outlet_surface_mesh_pt: " <<
    // Outlet_surface_mesh_pt->ninternal_data() << endl; cout <<
    // "Top_inlet_surface_mesh_pt: " <<
    // Top_inlet_surface_mesh_pt->ninternal_data() << endl; cout <<
    // "Bottom_inlet_surface_mesh_pt: " <<
    // Bottom_inlet_surface_mesh_pt->ninternal_data() << endl; cout <<
    // "Flux_mesh_pt: " << Flux_mesh_pt->ninternal_data() << endl;
  ...
  void FingerProblem<ELEMENT>::set_boundary_conditions()
  {
    ...
    //unsigned num_nod = Fluid_mesh_pt->nboundary_node(Lower_inlet_boundary_id);
    //for (unsigned inod = 0; inod < num_nod; inod++)
    //{
    //  Node* node_pt = Fluid_mesh_pt->boundary_node_pt(Lower_inlet_boundary_id, inod);
    //  node_pt->set_value(0, fixed_pressure);
    //  node_pt->pin(0);
    //}
