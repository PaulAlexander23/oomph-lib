...
public:
  ...
  void actions_after_adapt()
  {
    ...
    RefineableSphericalNavierStokesEquations::unpin_all_pressure_dofs(
      mesh_pt()->element_pt());

    // Pin redudant pressure dofs
    RefineableSphericalNavierStokesEquations::pin_redundant_nodal_pressures(
      mesh_pt()->element_pt());
...
int main()
{
  ...
  // Doing QCrouzeixRaviartElements
  {
    ...
    trace_file << "time " << "u " << "v " << "w " << std::endl;
