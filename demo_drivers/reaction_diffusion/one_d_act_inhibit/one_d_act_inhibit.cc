...
template<class ELEMENT>
RefineableOneDAdvectionDiffusionReactionProblem<
  ELEMENT>::RefineableOneDAdvectionDiffusionReactionProblem()
{
  ...
  mesh_pt()->boundary_node_pt(0, 0)->make_periodic(
...
//=====================================================================
template<class ELEMENT>
void RefineableOneDAdvectionDiffusionReactionProblem<
...
int main()
{
  ...
  RefineableOneDAdvectionDiffusionReactionProblem<
    RefineableQAdvectionDiffusionReactionElement<2, 1, 3>>
    problem;
