  ...
  : Source_fct_pt(source_fct_pt)
{
  ...
  // Create mesh
  Problem::mesh_pt() =
    new GeompackQuadMesh<ELEMENT>(mesh_file_name, curve_file_name);
...
int main(int argc, char* argv[])
{
  ...
  if (argc != 3)
  {
    ...
    error_message += "filename.mh2 then filename.cs2\n";
  ...
  PoissonProblem<QPoissonElement<2, 2>> problem(
    &TanhSolnForPoisson::get_source, mesh_file_name, curve_file_name);
