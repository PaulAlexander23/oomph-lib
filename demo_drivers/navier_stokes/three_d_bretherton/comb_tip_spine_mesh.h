...
//other boundaries different from bound1 and bound2) The function neeeds the
// boundary numbers to be merged and the end total number of boundaries (the
// merged boundaries can still exists but they
