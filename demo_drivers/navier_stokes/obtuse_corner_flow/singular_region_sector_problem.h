...
namespace oomph
{
  ...
  template<class ELEMENT>
  void SingularRegionSectorProblem<ELEMENT>::create_slip_eigen_elements()
  {
  ...
  template<class ELEMENT>
  void SingularRegionSectorProblem<ELEMENT>::create_traction_eigen_elements()
  {
  ...
  template<class ELEMENT>
  void SingularRegionSectorProblem<
  ...
  template<class ELEMENT>
  void SingularRegionSectorProblem<ELEMENT>::find_corner_bulk_element(
  ...
  template<class ELEMENT>
  void SingularRegionSectorProblem<ELEMENT>::find_corner_bulk_node(
    const unsigned& boundary_1_id,
    const unsigned& boundary_2_id,
    unsigned& element_index,
    unsigned& node_index)
  ...
  template<class ELEMENT>
  void SingularRegionSectorProblem<ELEMENT>::setup_mesh_interaction()
  {
  ...
  template<class ELEMENT>
  void SingularRegionSectorProblem<ELEMENT>::
