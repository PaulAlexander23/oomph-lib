#ifndef SINGULAR_SECTOR_PROBLEM_HEADER
#define SINGULAR_SECTOR_PROBLEM_HEADER
...
namespace oomph
{
  ...
  public:
    ...
    // Constructor
    SingularSectorProblem()
      : SectorProblem<ELEMENT>(), Contact_line_node_pt(0), Contact_angle(0.0)
    {
