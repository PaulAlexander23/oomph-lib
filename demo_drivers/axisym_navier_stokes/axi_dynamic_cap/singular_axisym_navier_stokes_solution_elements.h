...
#ifndef SINGULAR_AXISYM_NAVIER_STOKES_SOLUTION_ELEMENTS_HEADER
#define SINGULAR_AXISYM_NAVIER_STOKES_SOLUTION_ELEMENTS_HEADER
...
namespace oomph
{
  ...
  class SingularAxisymNavierStokesSolutionElement
  ...
  public:
    /// Constructor
    SingularAxisymNavierStokesSolutionElement()
    {
      ...
      unsigned* direction_pt)
    {
      ...
      for (unsigned j = 0; j < nnod; j++)
      {
        ...
        // SingularAxisymNavierStokesSolutionElement class. Note that this
      ...
      const unsigned& flag)
    {
      ...
      if (eqn_number >= 0)
      {
        ...
        if (flag)
        {
          ...
          // element pointed by
          // the SingularAxisymNavierStokesSolutionElement class
  ...
  }; // End of SingularAxisymNavierStokesSolutionElement class
} // namespace oomph
#endif
