...
namespace TanhSolnForPoisson
{
  ...
  void get_exact_u(const Vector<double>& x, Vector<double>& u)
  {
    ...
    u[0] = std::tanh(
      Alpha * ((x[0] - X_0) * N_x + (x[1] - Y_0) * N_y + (x[2] - Z_0) * N_z) /
      d);
  } // End of get_exact_u
...
ExtrudedMovingCylinderProblem<TWO_D_ELEMENT, THREE_D_ELEMENT>::
  ExtrudedMovingCylinderProblem(
    const PoissonEquations<3>::PoissonSourceFctPt& source_fct_pt)
  : Bulk_mesh_pt(0), Source_fct_pt(0)
{
...
//========================================================================
template<class TWO_D_ELEMENT, class THREE_D_ELEMENT>
void ExtrudedMovingCylinderProblem<TWO_D_ELEMENT,
                                   THREE_D_ELEMENT>::create_extruded_mesh()
{
  // Start the clock
  ...
  // Build central mesh
  RefineableRectangleWithHoleAndAnnularRegionMesh<TWO_D_ELEMENT>*
    two_d_mesh_pt =
...
template<class TWO_D_ELEMENT, class THREE_D_ELEMENT>
void ExtrudedMovingCylinderProblem<TWO_D_ELEMENT,
                                   THREE_D_ELEMENT>::apply_boundary_conditions()
{
...
template<class TWO_D_ELEMENT, class THREE_D_ELEMENT>
void ExtrudedMovingCylinderProblem<TWO_D_ELEMENT,
                                   THREE_D_ELEMENT>::complete_element_setup()
{
                                   ...
                                   THREE_D_ELEMENT>::doc_solution()
{
  ...
  mesh_pt()->output_fct(
    some_file, n_plot_point, TanhSolnForPoisson::get_exact_u);
