...
int main(int argc, char** argv)
{
  ...
  // MATRIX BASED SOLVE / CRDoubleMatrix (distributed)
  {
    ...
    OneDPoissonProblem<QPoissonElement<1, 4>> problem(
      n_element, FishSolnOneDPoisson::source_function);
    unsigned ndof = problem.ndof();
    LinearAlgebraDistribution distributed_dist(
      problem.communicator_pt(), ndof, true);
  ...
  // PROBLEM BASED SOLVE (distributed)
  {
    oomph_info << "////////////////////////////////////////////////////////////"
                  "///////////"
               << std::endl;
    oomph_info << "TESTING: SuperLU_dist distributed solve" << std::endl;
    oomph_info << "////////////////////////////////////////////////////////////"
                  "///////////"
               << std::endl
               << std::endl;
