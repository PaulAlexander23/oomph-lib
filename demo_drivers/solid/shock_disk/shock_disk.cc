...
void DiskShockWaveProblem<ELEMENT, TIMESTEPPER>::doc_solution()
{
  ...
  for (unsigned e = 0; e < nel; e++)
  {
    ...
    for (unsigned i = 0; i < npts; i++)
    {
      ...
      some_file << x_dummy[0] << " " << x_dummy[1] << " " << traction[0] << " "
                << traction[1] << " " << std::endl;
    }
  }
  some_file.close();
  ...
  for (unsigned e = 0; e < nel; e++)
  {
    ...
    for (unsigned i = 0; i < npts; i++)
    {
      ...
      for (unsigned j = 0; j < npts; j++)
      {
        ...
        some_file << x[0] << " " << x[1] << " " << displ[0] << " " << displ[1]
  ...
  const unsigned& case_number)
{
  ...
  //    cout << "You specified the following command line arguments: " <<
  //    std::endl; CommandLineArgs::output();
  //    //assert(false);
  //   }
...
int main(int argc, char* argv[])
{
  ...
  {
    cout << "Running case " << case_number << ": Pure displacement formulation"
         << std::endl;
  ...
  // Pressure-displacement with Crouzeix Raviart-type pressure
  {
    cout << "Running case " << case_number
         << ": Pressure/displacement with Crouzeix-Raviart pressure"
         << std::endl;
