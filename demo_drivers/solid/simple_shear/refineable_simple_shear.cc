...
public:
  ...
  RefineableElasticCubicMesh(
    ...
    : SimpleCubicMesh<ELEMENT>(
        nx, ny, nz, -a, a, -b, b, -c, c, time_stepper_pt),
  ...
  : Shear(0.0)
{
  ...
  Problem::mesh_pt() =
    new RefineableElasticCubicMesh<ELEMENT>(nx, ny, nz, a, b, c);
...
int main()
{
...

  {
    ...
    SimpleShearProblem<RefineableQPVDElementWithContinuousPressure<3>> problem(
      false);
