    ...
    void output(std::ostream& outfile, const unsigned& n_plot)
    {
      ...
      for (unsigned l2 = 0; l2 < n_plot; l2++)
      {
        ...
        for (unsigned l1 = 0; l1 < n_plot; l1++)
        {
          ...
          // Output displacements, the difference between Eulerian and
...
void CompressedSquareProblem<ELEMENT>::doc_solution(const bool& incompress)
{
  ...
  Trace_file << Global_Physical_Variables::Gravity << " " << Trace_node_pt->x(0)
  ...
  for (unsigned e = 0; e < nelem; e++)
  {
    ...
    for (unsigned l2 = 0; l2 < n_plot; l2++)
    {
      ...
      for (unsigned l1 = 0; l1 < n_plot; l1++)
      {
        ...
        double v_exact = Global_Physical_Variables::Gravity * (1.0 + nu) *
                         (1.0 - 2 * nu) / (1.0 - nu) *
                         (0.5 * x[1] * x[1] - x[1]);
        ...
        // Stresses
        sigma(0, 0) =
          nu / (1.0 - nu) * Global_Physical_Variables::Gravity * (x[1] - 1.0);
        sigma(1, 0) = 0.0;
...
int main()
{
  ...
  //===========================================
  {
    ...
    for (unsigned i = 0; i < 3; i++)
    {
      ...
      if (i != 2)
      {
        ...
        incompress = false;
        CompressedSquareProblem<MySolidElement<QPVDElement<2, 3>>> problem(
          incompress);
      ...
      //-----------------------------------------------------------
      {
        ...
        CompressedSquareProblem<
          MySolidElement<QPVDElementWithContinuousPressure<2>>>
          problem(incompress);
      ...
      //--------------------------------------------------------------
      {
        ...
        CompressedSquareProblem<MySolidElement<QPVDElementWithPressure<2>>>
          problem(incompress);
  ...
  //=============================
  {
    ...
    {
      case_number++;
      std::cout << "Doing Mooney Rivlin with cont pressure formulation: Case "
                << case_number << std::endl;
