...
namespace oomph
{
  ...
  /*   double denom = ((first_segment_vertex[1][1] -
   * first_segment_vertex[0][1])* */
  /*                   (second_segment_vertex[1][0] -
   * second_segment_vertex[0][0])) - */
  /*    ((first_segment_vertex[1][0] - first_segment_vertex[0][0])* */
  /*     (second_segment_vertex[1][1] - second_segment_vertex[0][1])); */

  /*   double nume_a = ((first_segment_vertex[1][0] -
   * first_segment_vertex[0][0])* */
  /*                    (second_segment_vertex[0][1] -
   * first_segment_vertex[0][1])) - */
  /*    ((first_segment_vertex[1][1] - first_segment_vertex[0][1])* */
  /*     (second_segment_vertex[0][0] - first_segment_vertex[0][0])); */

  /*   double nume_b = ((second_segment_vertex[1][0] -
   * second_segment_vertex[0][0])* */
  /*                    (second_segment_vertex[0][1] -
   * first_segment_vertex[0][1])) - */
  /*    ((second_segment_vertex[1][1] - second_segment_vertex[0][1])* */
  ...
  /// problem and the index at which the temperature is stored in the bulk
  /// element
  //======================================================================
  ...
  public:
    ...
    TemplateFreeUnsteadyHeatBaseFaceElement()
      : U_index_ust_heat(0), Dim(0), Flux_fct_pt(0)
    {
    }
  ...
  /*  void enable_smoothed_sun_shadow(const double&
  ...
  /*  /// radiation in terms of directional solar flux (unit vector and
   * magnitude) */
  ...
  /*      // with the horizontal */
  /*      double
   * theta=atan2(solar_flux_unit_vector[0],-solar_flux_unit_vector[1]); */
  ...
  /* /// Output illumination angles for all integration points */
  /* //===================================================================== */
  /* void SolarRadiationBase::output_atmospheric_radiation(std::ostream
   * &outfile) */
  /* { */
  ...
  /*  /// integration points): */
  /*  /// Stefan_boltzmann_illumination_info[ipt].size() = number of
   * illuminating */
  /*  ///       elements */
  ...
  /*  ///       that are visible from current element's ipt'th integration
   * point. */
  ...
  /*     { */
  /*      if
   * (Stefan_boltzmann_illumination_info[ipt][e].first==illuminating_el_pt) */
  /*       { */
  /*        throw OomphLibError( */
  ...
  /*  /// Stefan_boltzmann_illumination_info[ipt][e].second = vector containing
   */
  /*  ///       index of integration points in e-th illuminating element that
   * are */
  ...
  /* //===================================================================== */
  /* double
   * StefanBoltzmannRadiationBase::contribution_to_stefan_boltzmann_radiation(
   */
  /*  const Vector<double>& r_illuminated, */
  /*  const Vector<double>& n_illuminated, */
  /*  const Vector<unsigned>& visible_intpts_in_current_element, */
  ...
  /*    // where  */
  /*    // d\varphi=1/|{\bf R}| \partial {\bf R}/\partial s \cdot {\bf
   * e}_\varphi ds */
  ...
  /*      unsigned
   * n_pts=(Stefan_boltzmann_illumination_info[ipt][i2].second).size(); */
        ...
        if (bulk_el_pt->dim() == 3)
        {
          ...
          if (dynamic_cast<RefineableElement*>(bulk_el_pt))
          {
            ...
            std::string error_string = "This face element will not work "
                                       "correctly if nodes are hanging.\n";
      ...
      switch (Dim)
      {
        ...
        case 1:
        {
          ...
          if (eqn_pt == 0)
          {
            ...
            error_string += "Nodes are one dimensional, but cannot cast the "
                            "bulk element to\n";
        ...
        case 2:
        {
          ...
          if (eqn_pt == 0)
          {
            std::string error_string =
              "Bulk element must inherit from UnsteadyHeatEquations.";
            error_string += "Nodes are two dimensional, but cannot cast the "
                            "bulk element to\n";
  ...
  /*  /// the Jacobian of mapping between local and global (Eulerian) */
  /*  /// coordinates */
  /*  inline double shape_and_test(const Vector<double> &s, Shape &psi, Shape
   * &test) */
  /*   const */
  /*   { */
  /*    //Find number of nodes */
  ...
  //======================================================================
  template<class ELEMENT>
  class SurfaceMeltElement : public virtual FaceGeometry<ELEMENT>,
  ...
  public:
      ...
      : UnsteadyHeatBaseFaceElement<ELEMENT>(bulk_el_pt, face_index)
    {
      ...
      /*  { */
      /*   SolidNode*
       * bulk_nod_pt=dynamic_cast<SolidNode*>(bulk_el_pt->node_pt(j)); */
      /*   unsigned do_it=true; */
    ...
    for (unsigned ipt = 0; ipt < n_intpt; ipt++)
    {
      ...
      for (unsigned l = 0; l < n_node; l++)
      {
        ...
        for (unsigned k = 0; k < n_position_type; k++)
        {
          ...
          for (unsigned i = 0; i < n_dim; i++)
          {
            ...
            interpolated_dxdt[i] +=
              this->dnodal_position_gen_dt(l, bulk_position_type(k), i) *
              psi(l, k);
      ...
      switch (n_dim)
      {
        ...
        case 3:
          ...
          break;
        default:
          throw OomphLibError("Wrong dimension in SurfaceMeltElement",
                              OOMPH_CURRENT_FUNCTION,
                              OOMPH_EXCEPTION_LOCATION);
      }
