...
namespace oomph
{
  ...
  public:
    ...
    UnsteadyHeatFluxPseudoMeltElement(
      const UnsteadyHeatFluxPseudoMeltElement& dummy)
    {
                                 ...
                                 const unsigned& j)
    {
      ...
      soln_outfile << u_back << " " << m_back << " " << residuals[global_eqn_u]
      ...
      for (unsigned i = 0; i < nplot; i++)
      {
        ...
        for (unsigned j = 0; j < nplot; j++)
        {
          ...
          problem_pt->get_residuals(residuals);
          landscape_outfile << x0 << " " << x1 << " " << residuals[global_eqn_u]
                            << " " << residuals[global_eqn_m] << std::endl;
        }
      }
  ...
  //===========================================================================
  template<class ELEMENT>
  UnsteadyHeatFluxPseudoMeltElement<ELEMENT>::UnsteadyHeatFluxPseudoMeltElement(
    FiniteElement* const& bulk_el_pt, const int& face_index, const unsigned& id)
