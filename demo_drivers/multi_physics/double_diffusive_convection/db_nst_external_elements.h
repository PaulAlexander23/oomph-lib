...
public:
  ...
  RefineableQCrouzeixRaviartElementWithTwoExternalElement()
    : RefineableQCrouzeixRaviartElement<DIM>(), ElementWithExternalElement()
  {
                                        ...
                                        DenseMatrix<double>& jacobian)
  {
    ...
    RefineableQCrouzeixRaviartElement<DIM>::fill_in_contribution_to_jacobian(
      residuals, jacobian);
...
//=============================================================================
template<unsigned DIM>
void RefineableQCrouzeixRaviartElementWithTwoExternalElement<
...
//=========================================================================
template<>
double RefineableQCrouzeixRaviartElementWithTwoExternalElement<
