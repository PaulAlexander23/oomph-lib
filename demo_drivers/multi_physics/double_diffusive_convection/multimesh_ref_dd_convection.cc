...
//========================================================================
template<class NST_ELEMENT, class AD_ELEMENT>
RefineableDDConvectionProblem<NST_ELEMENT,
                              AD_ELEMENT>::RefineableDDConvectionProblem()
{
  ...
  // Build the meshes
  Nst_mesh_pt = new RefineableRectangularQuadMesh<NST_ELEMENT>(
    n_x, n_y, l_x, l_y, time_stepper_pt());
  Temp_mesh_pt = new RefineableRectangularQuadMesh<AD_ELEMENT>(
    n_x, n_y, l_x, l_y, time_stepper_pt());
  Conc_mesh_pt = new RefineableRectangularQuadMesh<AD_ELEMENT>(
    n_x, n_y, l_x, l_y, time_stepper_pt());
...
int main(int argc, char** argv)
{
  ...
  RefineableDDConvectionProblem<
    ...
    RefineableQAdvectionDiffusionElementWithExternalElement<2>>
    problem;
