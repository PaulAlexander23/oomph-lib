...
namespace Global_Parameters
{
  ...
  void exact_u(const Vector<double>& x, Vector<double>& u)
  {
    ...
    MapleGenVar3 =
      Displacement_amplitude * Nu * omega *
        BesselY(
          0.0,
          omega /
      ...
      Displacement_amplitude *
        BesselY(
          ...
          omega /
            ...
            (1.0 + H_annulus)) *
        omega * H_annulus +
      Displacement_amplitude * sqrt(-(1.0 - Nu) / (-1.0 + Nu + 2.0 * Nu * Nu)) *
        BesselY(
          1.0,
          omega /
            sqrt(Nu / (1.0 + Nu) / (1.0 - 2.0 * Nu) + 2.0 / (2.0 + 2.0 * Nu)) *
            (1.0 + H_annulus)) -
      2.0 * Displacement_amplitude *
        sqrt(-(1.0 - Nu) / (-1.0 + Nu + 2.0 * Nu * Nu)) *
        BesselY(
          1.0,
          omega /
            sqrt(Nu / (1.0 + Nu) / (1.0 - 2.0 * Nu) + 2.0 / (2.0 + 2.0 * Nu)) *
    ...
    MapleGenVar2 =
      MapleGenVar3 -
      BesselY(1.0,
              omega / sqrt(Nu / (1.0 + Nu) / (1.0 - 2.0 * Nu) +
                           2.0 / (2.0 + 2.0 * Nu))) *
        P * sqrt(-(1.0 - Nu) / (-1.0 + Nu + 2.0 * Nu * Nu)) -
      BesselY(1.0,
              omega / sqrt(Nu / (1.0 + Nu) / (1.0 - 2.0 * Nu) +
                           2.0 / (2.0 + 2.0 * Nu))) *
        P * sqrt(-(1.0 - Nu) / (-1.0 + Nu + 2.0 * Nu * Nu)) * H_annulus +
      BesselY(1.0,
              omega / sqrt(Nu / (1.0 + Nu) / (1.0 - 2.0 * Nu) +
                           2.0 / (2.0 + 2.0 * Nu))) *
        P * sqrt(-(1.0 - Nu) / (-1.0 + Nu + 2.0 * Nu * Nu)) * Nu +
      BesselY(1.0,
              omega / sqrt(Nu / (1.0 + Nu) / (1.0 - 2.0 * Nu) +
                           2.0 / (2.0 + 2.0 * Nu))) *
        P * sqrt(-(1.0 - Nu) / (-1.0 + Nu + 2.0 * Nu * Nu)) * Nu * H_annulus +
      2.0 *
        BesselY(1.0,
                omega / sqrt(Nu / (1.0 + Nu) / (1.0 - 2.0 * Nu) +
                             2.0 / (2.0 + 2.0 * Nu))) *
        P * sqrt(-(1.0 - Nu) / (-1.0 + Nu + 2.0 * Nu * Nu)) * Nu * Nu +
      2.0 *
        BesselY(1.0,
                omega / sqrt(Nu / (1.0 + Nu) / (1.0 - 2.0 * Nu) +
                             2.0 / (2.0 + 2.0 * Nu))) *
    ...
    MapleGenVar6 =
      ...
      sqrt(-(1.0 - Nu) / (-1.0 + Nu + 2.0 * Nu * Nu)) *
        ...
        BesselJ(1.0,
                omega / sqrt(Nu / (1.0 + Nu) / (1.0 - 2.0 * Nu) +
                             2.0 / (2.0 + 2.0 * Nu))) -
      2.0 * sqrt(-(1.0 - Nu) / (-1.0 + Nu + 2.0 * Nu * Nu)) *
        BesselY(
          1.0,
          omega /
            sqrt(Nu / (1.0 + Nu) / (1.0 - 2.0 * Nu) + 2.0 / (2.0 + 2.0 * Nu)) *
    ...
    MapleGenVar5 = BesselJ(
      1.0,
      omega /
        sqrt(Nu / (1.0 + Nu) / (1.0 - 2.0 * Nu) + 2.0 / (2.0 + 2.0 * Nu)) * r);
    ...
    MapleGenVar6 =
      ...
      P * sqrt(-(1.0 - Nu) / (-1.0 + Nu + 2.0 * Nu * Nu)) * Nu * H_annulus *
        BesselJ(1.0,
                omega / sqrt(Nu / (1.0 + Nu) / (1.0 - 2.0 * Nu) +
                             2.0 / (2.0 + 2.0 * Nu))) +
      2.0 * P * sqrt(-(1.0 - Nu) / (-1.0 + Nu + 2.0 * Nu * Nu)) * Nu * Nu *
        BesselJ(1.0,
                omega / sqrt(Nu / (1.0 + Nu) / (1.0 - 2.0 * Nu) +
                             2.0 / (2.0 + 2.0 * Nu))) +
      2.0 * P * sqrt(-(1.0 - Nu) / (-1.0 + Nu + 2.0 * Nu * Nu)) * Nu * Nu *
                   ...
                   BesselJ(0.0,
                           omega /
                             sqrt(Nu / (1.0 + Nu) / (1.0 - 2.0 * Nu) +
                                  2.0 / (2.0 + 2.0 * Nu)) *
                             (1.0 + H_annulus)) *
                     omega * Displacement_amplitude -
                   BesselJ(0.0,
                           omega /
                             sqrt(Nu / (1.0 + Nu) / (1.0 - 2.0 * Nu) +
                                  2.0 / (2.0 + 2.0 * Nu)) *
                             (1.0 + H_annulus)) *
                     omega * H_annulus * Displacement_amplitude;
    MapleGenVar5 =
      MapleGenVar7 +
      sqrt(-(1.0 - Nu) / (-1.0 + Nu + 2.0 * Nu * Nu)) *
        BesselJ(
...
AnnularDiskProblem<ELASTICITY_ELEMENT>::AnnularDiskProblem()
{
  ...
  // Build solid mesh
  Solid_mesh_pt =
    new TwoDAnnularMesh<ELASTICITY_ELEMENT>(periodic,
                                            azimuthal_fraction_of_coating,
                                            Global_Parameters::Ntheta,
                                            Global_Parameters::Nr,
                                            a,
...
int main(int argc, char** argv)
{
  ...
  // Number of elements in azimuthal direction
  CommandLineArgs::specify_command_line_flag("--ntheta",
                                             &Global_Parameters::Ntheta);

  // Number of elements in radial direction
  CommandLineArgs::specify_command_line_flag("--nr", &Global_Parameters::Nr);
