...
namespace Global_parameters
{
  ...
  Vector<double> grad_f1(const Vector<double>& coord)
  {
    ...
    if (not(Blend))
    {
      /// Without blending
      df1[0] =
        -(x / 2.0 - 0.25) * sin(0.5 * atan2(-y + 1.0, -x + 0.5)) /
          pow((-x + 0.5) * (-x + 0.5) + (-y + 1.0) * (-y + 1.0), 3.0 / 4.0) +
        0.5 * (y - 1.0) * cos(0.5 * atan2(-y + 1.0, -x + 0.5)) /
          pow((-x + 0.5) * (-x + 0.5) + (-y + 1.0) * (-y + 1.0), 3.0 / 4.0);

      df1[1] =
        0.5 * (-x + 0.5) * cos(0.5 * atan2(-y + 1.0, -x + 0.5)) /
          pow((-x + 0.5) * (-x + 0.5) + (-y + 1.0) * (-y + 1.0), 3.0 / 4.0) -
      ...
      else
      {
        df1[0] =
          (-(x / 2.0 - 0.25) * sin(0.5 * atan2(-y + 1.0, -x + 0.5)) /
             pow((-x + 0.5) * (-x + 0.5) + (-y + 1.0) * (-y + 1.0), 3.0 / 4.0) +
           0.5 * (y - 1.0) * cos(0.5 * atan2(-y + 1.0, -x + 0.5)) /
             pow((-x + 0.5) * (-x + 0.5) + (-y + 1.0) * (-y + 1.0),
                 3.0 / 4.0)) *
            (0.5 * cos(Pi *
                       sqrt((-x + 0.5) * (-x + 0.5) + (-y + 1.0) * (-y + 1.0)) /
                       R_blend) +
             0.5) -
          0.5 * Pi * (x - 0.5) *
            (-pow((-x + 0.5) * (-x + 0.5) + (-y + 1.0) * (-y + 1.0),
             ...
             1.0) *
            sin(Pi * sqrt((-x + 0.5) * (-x + 0.5) + (-y + 1.0) * (-y + 1.0)) /
                R_blend) /
        ...
        df1[1] =
          (0.5 * (-x + 0.5) * cos(0.5 * atan2(-y + 1.0, -x + 0.5)) /
           ...
           (y / 2.0 - 1.0 / 2.0) * sin(0.5 * atan2(-y + 1.0, -x + 0.5)) /
             pow(pow(-x + 0.5, 2) + pow(-y + 1.0, 2), 3.0 / 4.0)) *
            (0.5 *
               cos(Pi * sqrt(pow(-x + 0.5, 2) + pow(-y + 1.0, 2)) / R_blend) +
             0.5) -
          0.5 * Pi * (y - 1.0) *
            (-pow(pow(-x + 0.5, 2) + pow(-y + 1.0, 2), 1.0 / 4.0) *
               sin(0.5 * atan2(-y + 1.0, -x + 0.5)) +
             1.0) *
  ...
  Vector<double> grad_f2(const Vector<double>& coord)
  {
    ...
    if (not(Blend))
    {
      ...
      df2[0] = -(x / 2.0 - 0.75) * cos(0.5 * atan2(-y + 1.0, -x + 1.5)) /
               ...
               0.5 * (y - 1.0) * sin(0.5 * atan2(-y + 1.0, -x + 1.5)) /
                 pow(pow(-x + 1.5, 2) + pow(-y + 1.0, 2), 3.0 / 4.0);

      df2[1] = -0.5 * (-x + 1.5) * sin(0.5 * atan2(-y + 1.0, -x + 1.5)) /
                 pow(pow(-x + 1.5, 2) + pow(-y + 1.0, 2), 3.0 / 4.0) -
               (y / 2.0 - 1.0 / 2.0) * cos(0.5 * atan2(-y + 1.0, -x + 1.5)) /
                 pow(pow(-x + 1.5, 2) + pow(-y + 1.0, 2), 3.0 / 4.0);
    }
    ...
    else
    {
      ...
      {
        df2[0] =
          (-(x / 2.0 - 0.75) * cos(0.5 * atan2(-y + 1.0, -x + 1.5)) /
             pow(pow(-x + 1.5, 2) + pow(-y + 1.0, 2), 3.0 / 4.0) -
           0.5 * (y - 1.0) * sin(0.5 * atan2(-y + 1.0, -x + 1.5)) /
             pow(pow(-x + 1.5, 2) + pow(-y + 1.0, 2), 3.0 / 4.0)) *
            (0.5 *
               cos(Pi * sqrt(pow(-x + 1.5, 2) + pow(-y + 1.0, 2)) / R_blend) +
             0.5) -
          0.5 * Pi * (x - 1.5) *
            (-pow(pow(-x + 1.5, 2) + pow(-y + 1.0, 2), 1.0 / 4.0) *
               cos(0.5 * atan2(-y + 1.0, -x + 1.5)) +
             1.0) *
            sin(Pi * sqrt(pow(-x + 1.5, 2) + pow(-y + 1.0, 2)) / R_blend) /
            (R_blend * sqrt(pow(-x + 1.5, 2) + pow(-y + 1.0, 2)));

        df2[1] =
          (-0.5 * (-x + 1.5) * sin(0.5 * atan2(-y + 1.0, -x + 1.5)) /
             pow(pow(-x + 1.5, 2) + pow(-y + 1.0, 2), 3.0 / 4.0) -
           (y / 2.0 - 1.0 / 2.0) * cos(0.5 * atan2(-y + 1.0, -x + 1.5)) /
             pow(pow(-x + 1.5, 2) + pow(-y + 1.0, 2), 3.0 / 4.0)) *
            (0.5 *
  ...
  void source_function(const Vector<double>& coord, double& source)
  {
    ...
    source =
      (x - 1.5) * (3.0 * x - 4.5) * cos(0.5 * atan2(-y + 1.0, -x + 1.5)) /
        (4.0 * pow((x - 1.5) * (x - 1.5) + (y - 1.0) * (y - 1.0), 7.0 / 4.0)) -
      0.25 * (x - 1.5) * (y - 1.0) * sin(0.5 * atan2(-y + 1.0, -x + 1.5)) /
        pow((x - 1.5) * (x - 1.5) + (y - 1.0) * (y - 1.0), 7.0 / 4.0) +
      (x - 0.5) * (3.0 * x - 1.5) * sin(0.5 * atan2(-y + 1.0, -x + 0.5)) /
        (4.0 * pow((x - 0.5) * (x - 0.5) + (y - 1.0) * (y - 1.0), 7.0 / 4.0)) +
      (x - 0.5) * (y - 1.0) * cos(0.5 * atan2(-y + 1.0, -x + 0.5)) /
        (4.0 * pow((x - 0.5) * (x - 0.5) + (y - 1.0) * (y - 1.0), 7.0 / 4.0)) +
      (3.0 * x - 4.5) * (y - 1.0) * sin(0.5 * atan2(-y + 1.0, -x + 1.5)) /
        (4.0 * pow((x - 1.5) * (x - 1.5) + (y - 1.0) * (y - 1.0), 7.0 / 4.0)) -
      0.25 * (3.0 * x - 1.5) * (y - 1.0) *
        cos(0.5 * atan2(-y + 1.0, -x + 0.5)) /
        pow((x - 0.5) * (x - 0.5) + (y - 1.0) * (y - 1.0), 7.0 / 4.0) +
      ...
      ((x - 1.5) * (x - 1.5) * cos(0.5 * atan2(-y + 1.0, -x + 1.5)) /
         pow((x - 1.5) * (x - 1.5) + (y - 1.0) * (y - 1.0), 7.0 / 4.0) -
       2.0 * (x - 1.5) * (y - 1.0) * sin(0.5 * atan2(-y + 1.0, -x + 1.5)) /
         pow((x - 1.5) * (x - 1.5) + (y - 1.0) * (y - 1.0), 7.0 / 4.0) +
       (x - 0.5) * (x - 0.5) * sin(0.5 * atan2(-y + 1.0, -x + 0.5)) /
         pow((x - 0.5) * (x - 0.5) + (y - 1.0) * (y - 1.0), 7.0 / 4.0) +
       2.0 * (x - 0.5) * (y - 1.0) * cos(0.5 * atan2(-y + 1.0, -x + 0.5)) /
         pow((x - 0.5) * (x - 0.5) + (y - 1.0) * (y - 1.0), 7.0 / 4.0) +
       3.0 * (y - 1.0) * (y - 1.0) * sin(0.5 * atan2(-y + 1.0, -x + 0.5)) /
         pow((x - 0.5) * (x - 0.5) + (y - 1.0) * (y - 1.0), 7.0 / 4.0) +
       3.0 * (y - 1.0) * (y - 1.0) * cos(0.5 * atan2(-y + 1.0, -x + 1.5)) /
         pow((x - 1.5) * (x - 1.5) + (y - 1.0) * (y - 1.0), 7.0 / 4.0) -
       1.0 * Pi * Pi * sin(0.5 * Pi * y) * cos(x) -
       2.0 * sin(0.5 * atan2(-y + 1.0, -x + 0.5)) /
         pow((x - 0.5) * (x - 0.5) + (y - 1.0) * (y - 1.0), 3.0 / 4.0) -
       2.0 * cos(0.5 * atan2(-y + 1.0, -x + 1.5)) /
  ...
  : Source_fct_pt(source_fct_pt)
{
  ...
  double x_right =
    unsigned((l_x - 0.5 * l_x * (1.0 - unpinned_fraction)) / dx) * dx;
  ...
  for (unsigned i = 0; i < n_y; i++)
  {
    ...
    {
      unsigned j = k * nnode_1d + nnode_1d - 1;
      // The node j is subject to Dirichlet BC
      el_pt->impose_dirichlet_bc_on_node(j);
      // Find the global coordinate at node j
      Vector<double> x(2);
  ...
  for (unsigned i = 0; i < n_x; i++)
  {
    ...
    for (unsigned k = 0; k < nnode_1d; k++)
    {
      unsigned j = (nnode_1d - 1) * nnode_1d + k;
      // The node j is subject to Dirichlet BC
      el_pt->impose_dirichlet_bc_on_node(j);
      // Find the global coordinate at node j
      Vector<double> x(2);
  ...
  // Loop that increases ilast until n_el+istart is the number of the last
  // element
  while (xlast < x_right)
  {
    // Increases the value of i
  ...
  {
    Singular_poisson_solution1_element_pt
      ->singular_function_satisfies_laplace_equation() = true;
  }
  ...
  Singular_poisson_solution_mesh_pt->add_element_pt(
    Singular_poisson_solution1_element_pt);
  ...
  // Global_parameters namespace
  Singular_poisson_solution2_element_pt->singular_fct_pt() =
...
void PoissonProblem<ELEMENT>::doc_solution(DocInfo& doc_info)
{
  ...
  sprintf(filename,
          ...
          doc_info.number());
  some_file.open(filename);
  Poisson_mesh_pt->compute_error(
    some_file, Global_parameters::get_exact_u, error, norm);
  some_file.close();
  ...
  oomph_info << "Value of C1 = " << Singular_poisson_solution1_element_pt->c()
             << std::endl;

  // Print the value of C2
  oomph_info << "Value of C2 = " << Singular_poisson_solution2_element_pt->c()
             << std::endl;
...
int main(int argc, char** argv)
{
  ...
  CommandLineArgs::specify_command_line_flag("--r_blend",
                                             &Global_parameters::R_blend);
  ...
  PoissonProblem<PoissonElementWithSingularity<QPoissonElement<2, 3>>> problem(
    &Global_parameters::source_function);
