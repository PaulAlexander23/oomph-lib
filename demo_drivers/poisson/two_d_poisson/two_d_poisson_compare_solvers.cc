         ...
         bool mess_up_order)
{
  ...
  PoissonProblem<QPoissonElement<2, 3>> problem(
    &TanhSolnForPoisson::get_source, nel_1d, mess_up_order);
...
int main()
{
  ...
  for (unsigned mess = 0; mess < 2; mess++)
  {
    ...
    cout << std::endl;
    cout << " Use HSL frontal solver MA42 without element re-ordering: "
         << std::endl;
    cout << "========================================================= "
         << std::endl;
    cout << std::endl;
    ...
    cout << std::endl;
    cout << " Use HSL frontal solver MA42 with element re-ordering: "
         << std::endl;
    cout << "====================================================== "
         << std::endl;
    cout << std::endl;
