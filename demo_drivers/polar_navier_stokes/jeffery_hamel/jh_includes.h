...
namespace oomph
{
  ...
  public:
    ...
    void set_pressure_data(Data* pext_pt)
    {
      ...
      External_data_number_of_Pext = this->add_external_data(Pext_pt);
    }
  ...
  public:
    ...
    void make_traction_elements(const bool& outlet)
    {
      ...
      if (outlet)
      {
        ibound = 1;
        index = 1;
        eta = Global_Physical_Variables::eta_outlet;
      }
      else
      {
        ibound = 3;
        index = -1;
        eta = Global_Physical_Variables::eta_inlet;
      }
      ...
      std::cout << std::endl
                << "Traction elements attached to mesh" << std::endl
                << std::endl;
    ...
    void make_shear_elements()
    {
      ...
      for (unsigned ibound = 0; ibound < 4; ibound += 2)
      {
        ...
        for (unsigned ielt = 0; ielt < num_elt; ielt++)
        {
          ...
          if (ibound == 0)
            ...
            this->Upper_stress_integral_elt_pt.push_back(surface_element_pt);
      ...
      std::cout << std::endl
                << "Shear elements attached to mesh" << std::endl
                << std::endl;
    ...
    void remove_traction_elements()
    {
      ...
      std::cout << std::endl
                << "Traction elements removed from mesh" << std::endl
                << std::endl;
    ...
    void remove_shear_elements()
    {
      ...
      std::cout << std::endl
                << "Shear elements removed from mesh" << std::endl
                << std::endl;
    ...
    void assign_fluid_element_vector()
    {
      ...
      if (check != 0)
      {
        ...
        std::cout << "whilst traction elements are attached to the mesh"
                  << std::endl;
      }
      else
      {
