...
namespace oomph
{
  ...
  public:
                                 ...
                                 Vector<double>& values)
    {
      ...
      else
      {
        ...
        RefineablePolarStreamfunctionEquations::get_interpolated_values(s,
                                                                        values);
      }
    }
  ...
  //=======================================================================
  /// Face geometry for the RefineableQuadStreamfunctionElement elements: The
      ...
      for (unsigned l = 0; l < n_node; l++)
      {
        ...
        for (unsigned m = 0; m < n_master; m++)
        {
          ...
          if (local_eqn >= 0)
          {
            ...
            residuals[local_eqn] +=
              (1. / (interpolated_x[0] * Alpha)) * interpolated_dsdx[1] *
                ...
                for (unsigned m2 = 0; m2 < n_master2; m2++)
                {
                  ...
                  if (is_node2_hanging)
                  {
                    ...
                    local_unknown = this->local_hang_eqn(
                      hang_info2_pt->master_node_pt(m2), s_nodal_index);
                  ...
                  if (local_unknown >= 0)
                  {
                    ...
                    jacobian(local_eqn, local_unknown) +=
                      dpsidx(l2, 0) * dtestdx(l, 0) * interpolated_x[0] *
