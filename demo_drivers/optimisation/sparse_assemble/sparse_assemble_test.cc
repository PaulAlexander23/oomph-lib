  ...
  const unsigned& method)
{
  ...
  switch (method)
  {
    case 1:
      ...
      std::cout << std::endl
                << "Oomph vector of pairs" << std::endl
                << std::endl;
      break;
    ...
    case 2:
      ...
      std::cout << std::endl << "Oomph two vectors" << std::endl << std::endl;
      break;

    case 3:

      Problem::Sparse_assembly_method = Problem::Perform_assembly_using_maps;


      std::cout << std::endl << "Oomph maps" << std::endl << std::endl;
      break;


    case 4:

      Problem::Sparse_assembly_method = Problem::Perform_assembly_using_lists;


      std::cout << std::endl << "Oomph lists" << std::endl << std::endl;
    ...
    case 5:
      ...
      std::cout << std::endl << "Oomph arrays" << std::endl << std::endl;
  ...
  sparse_assemble_row_or_column_compressed(
    col_index, row_start, value, nnz, residuals, compressed_row);

  clock_t clock2 = clock();
  // time_t time2 = time(0);

  cout << "CPU time for " << Global_Variables::Nx << " x "
       << Global_Variables::Ny << " mesh; assembly with method " << method
...
int main(int argc, char* argv[])
{
  ...
  {
    std::cout << "Wrong number of command line args specified!\n"
  ...
  cout << "Mesh with " << Global_Variables::Nx << " x " << Global_Variables::Ny
       << " elements." << std::endl;
