...
////
////  BOOST_TEST(abs(expected_eigenvalue[0].real() -
/// actual_eigenvalue[0].real()) /  < /             1e-3);
////}
//
...
//
//  // linear_problem_pt->doc_solution();
//  const double actual_centre_height =
//  linear_problem_pt->get_centre_point_ZC();
...
//// 0.0); /   linear_problem_pt->pin_interior_pressure(); /   CRDoubleMatrix
/// actual_jacobian; /   CRDoubleMatrix actual_mass_matrix; /
/// linear_problem_pt->get_eigenproblem_matrices(actual_mass_matrix, /
/// actual_jacobian);
////
////   save_dofs_types(problem_pt, "expected_dofs.txt");
...
////
/// linear_problem_pt->set_constant_lagrange_free_surface_boundary_condition(0.0,
//// 0.0); /   CRDoubleMatrix actual_jacobian; /   CRDoubleMatrix
/// actual_mass_matrix; /
/// linear_problem_pt->get_eigenproblem_matrices(actual_mass_matrix, /
/// actual_jacobian);
////
