#ifndef DECOMPOSED_PRESSURE_EVALUATION_ELEMENTS_HEADER
#define DECOMPOSED_PRESSURE_EVALUATION_ELEMENTS_HEADER
...
namespace oomph
{
  ...
  class DecomposedPressureEvaluationElement
  ...
  public:
    // Constructor
    DecomposedPressureEvaluationElement(FiniteElement* const& element_pt,
  ...
  protected:
      ...
      Vector<double>& residuals, DenseMatrix<double>& jacobian, unsigned flag)
    {
      ...
      if (el_dim != 1)
      {
        ...
        error_stream
          << "Currently, the DecomposedPressureEvaluationElement elements\n"
          ...
          << "   "
             "DecomposedPressureEvaluationElement::fill_in_generic_residual_"
  ...
  public:
    ...
    void output(std::ostream& outfile)
    {
      ...
      // Output the pressure
      outfile << interpolated_p(evalution_point_s, 0) << " ";
      outfile << interpolated_p(evalution_point_s, 1) << " ";
