...
namespace oomph
{
  ...
  class TwoLayerPerturbedSpineMesh : public RectangularQuadMesh<ELEMENT>,
                                     public PerturbedSpineMesh
  {
  public:
    /// Constructor: Pass in:
    ...
    void perturbed_spine_node_update(PerturbedSpineNode* spine_node_pt)
    {
      ...
      switch (id)
      {
        ...
        default:
          ...
          error_message << "Unknown id passed to perturbed_spine_node_update "
                        << id << std::endl;
          throw OomphLibError(
            error_message.str(),
