...
public:
  ...
  void actions_before_implicit_timestep()
  {
    ...
    {
      Global_Parameters::P_in =
        Global_Parameters::P_in_max *
  ...
  {
    std::cout << "\n\n=================================================\n";
    std::cout << "Average wall thickness: " << Wall_thickness << std::endl
              << std::endl;
    double speed_index = sqrt(Global_Parameters::Q /
                              (0.5 * Wall_thickness * Global_Parameters::Re));
    ...
    std::cout << "Square of Womersley   : " << alpha_sq << std::endl;
    std::cout << "=================================================\n\n";
  }
...
UnstructuredFSIProblem<FLUID_ELEMENT, SOLID_ELEMENT>::UnstructuredFSIProblem()
{
  ...
  Solid_mesh_pt = new SolidTetgenMesh<SOLID_ELEMENT>(
    node_file_name, element_file_name, face_file_name, wall_time_stepper_pt);
