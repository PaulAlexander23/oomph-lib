...
BOOST_AUTO_TEST_CASE(axisym_sector_problem_no_displacement)
{
...
// BOOST_AUTO_TEST_CASE(axisym_sector_problem_no_displacement_far_field)
//{
//   // Set parameter values
//   parameters::x_centre[0] = 2.0;
//
...
BOOST_AUTO_TEST_CASE(test_case_no_solid_displacement)
{
  // Set parameter values
  parameters::x_centre[0] = 2.0;
...
BOOST_AUTO_TEST_CASE(test_case_debug)
{
  // Set parameter values
  parameters::x_centre[0] = 2.0;
...
BOOST_AUTO_TEST_CASE(test_case_solid_displacement_jacobian)
{
  // Set parameter values
  parameters::x_centre[0] = 2.0;
  ...
  SingularAxisymSectorProblem<AxisymNavierStokesElementWithSingularity<
    Hijacked<ProjectableAxisymmetricTaylorHoodElement<
      PseudoSolidNodeUpdateElement<AxisymmetricTTaylorHoodElement,
                                   TPVDElement<2, 3>>>>>>
    problem;
  problem.unpin_solid_dofs();

  DoubleVector residuals;
  DenseMatrix<double> expected_jacobian;
  DenseDoubleMatrix actual_jacobian;
  problem.get_fd_jacobian(residuals, expected_jacobian);
  problem.get_jacobian(residuals, actual_jacobian);

  BOOST_TEST(actual_jacobian.nrow() == expected_jacobian.nrow());
  BOOST_TEST(actual_jacobian.ncol() == expected_jacobian.ncol());
...
// BOOST_AUTO_TEST_CASE(test_case_solid_displacement)
//{
//   // Set parameter values
//   parameters::x_centre[0] = 2.0;
//
