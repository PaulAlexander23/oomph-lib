                                           ...
                                           DocInfo& doc_info)
{
  ...
  // only for checking where plot points are
  if (false)
  {
    ...
    el_pt->node_pt(0)->x(2) = 0.0;

    el_pt->node_pt(1)->x(0) = 0.0;
    el_pt->node_pt(1)->x(1) = 1.0;
    el_pt->node_pt(1)->x(2) = 0.0;

    el_pt->node_pt(2)->x(0) = 1.0;
    el_pt->node_pt(2)->x(1) = 0.0;
    el_pt->node_pt(2)->x(2) = 0.0;

    el_pt->node_pt(3)->x(0) = 0.0;
    el_pt->node_pt(3)->x(1) = 0.0;
    el_pt->node_pt(3)->x(2) = 1.0;


    el_pt->node_pt(4)->x(0) = 0.0;
    el_pt->node_pt(4)->x(1) = 0.5;
    el_pt->node_pt(4)->x(2) = 0.0;

    el_pt->node_pt(5)->x(0) = 0.5;
    el_pt->node_pt(5)->x(1) = 0.0;
    el_pt->node_pt(5)->x(2) = 0.0;

    el_pt->node_pt(6)->x(0) = 0.0;
    el_pt->node_pt(6)->x(1) = 0.0;
    el_pt->node_pt(6)->x(2) = 0.5;


    el_pt->node_pt(7)->x(0) = 0.5;
    el_pt->node_pt(7)->x(1) = 0.5;
    el_pt->node_pt(7)->x(2) = 0.0;

    el_pt->node_pt(8)->x(0) = 0.5;
    el_pt->node_pt(8)->x(1) = 0.0;
    el_pt->node_pt(8)->x(2) = 0.5;

    el_pt->node_pt(9)->x(0) = 0.0;
    ...
    {
      some_file << el_pt->node_pt(j)->x(0) << " " << el_pt->node_pt(j)->x(1)
                << " " << el_pt->node_pt(j)->x(2) << " " << std::endl;
    }
    some_file.close();
...
int main(int argc, char* argv[])
{
  ...
  PoissonProblem<TPoissonElement<3, 3>> problem(&TanhSolnForPoisson::get_source,
                                                node_file_name,
                                                element_file_name,
                                                face_file_name);
