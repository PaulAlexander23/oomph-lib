...
public:
  ...
  //-------------------------------------------------------------------------
  void fix_pressure(const unsigned& ielem,
                                                      ...
                                                      ofstream& trace_file)
{
  ...
  ELEMENT* el_pt =
    dynamic_cast<ELEMENT*>(dynamic_cast<ELEMENT*>(mesh_pt()->element_pt(0))
                             ->quadtree_pt()
                             ->root_pt()
                             ->object_pt());
  ...
  trace_file << mesh_pt()->nelement() << " "
             ...
             << el_pt->u_nst(Nnode - 1, 0) << " " << el_pt->u_nst(Nnode - 1, 1)
             << " " << std::endl;
}
//========================================================================
...
void DrivenCavityProblem<ELEMENT, MESH>::run(unsigned& next_istep)
{
  ...
  mesh_pt()->get_refinement_levels(min_refinement_level, max_refinement_level);
  ...
  trace_file << "# min_refinement_level " << mesh_pt()->min_refinement_level()
             << std::endl;
  trace_file << "# max_refinement_level " << mesh_pt()->max_refinement_level()
             << std::endl;
  trace_file << "# A_ellips " << static_cast<Ellipse*>(wall_pt())->a_ellips()
             << std::endl;
  trace_file << "# B_ellips " << static_cast<Ellipse*>(wall_pt())->b_ellips()
             << std::endl;
...
int main()
{
...

  {
    ...
    cout << "=========================================================="
         << std::endl;
    cout << " " << std::endl;
    DrivenCavityProblem<ELEMENT1, MESH1>* problem_pt =
      new DrivenCavityProblem<ELEMENT1, MESH1>;
...

  {
    ...
    cout << "=========================================================="
         << std::endl;
    cout << " " << std::endl;
    DrivenCavityProblem<ELEMENT0, MESH0>* problem_pt =
      new DrivenCavityProblem<ELEMENT0, MESH0>;
...

  {
    ...
    cout << "=========================================================="
         << std::endl;
    cout << " " << std::endl;
    DrivenCavityProblem<ELEMENT3, MESH3>* problem_pt =
      new DrivenCavityProblem<ELEMENT3, MESH3>;
...

  {
    ...
    cout << "=========================================================="
         << std::endl;
    cout << " " << std::endl;
    DrivenCavityProblem<ELEMENT2, MESH2>* problem_pt =
      new DrivenCavityProblem<ELEMENT2, MESH2>;
