...
namespace oomph
{
  ...
  protected:
                          ...
                          Vector<double>& slip) const
    {
      ...
      {
        for (unsigned i = 0; i < slip.size(); i++)
        {
          slip[i] = 0;
        }
      }
    ...
    {
      if (Wall_velocity_fct_pt)
      {
        Wall_velocity_fct_pt(time, x, n, wall_velocity);
      }
      else
      {
        for (unsigned i = 0; i < wall_velocity.size(); i++)
        {
          wall_velocity[i] = 0;
        }
      }
  ...
  public:
    ...
    void output(std::ostream& outfile, const unsigned& n_plot)
    {
      ...
      for (unsigned iplot = 0; iplot < num_plot_points; iplot++)
      {
        ...
        outfile << interpolated_u[n_dim - 1] << std::endl;
      }
    }
  };
                  ...
                  if (is_pseudo_solid)
                  {
                    ...
                    for (unsigned j = 0; j < n_dim; j++)
                    {
                      ...
                      if (local_unknown >= 0)
                      {
                        ...
                        // always dpsifds(l2,0)
                        jacobian(local_eqn, local_unknown) +=
                          1.0 / slip[i] * psi(l) * this->nst_u(i, l2) *
                          dpsids(l2, 0) * w;
                      }
                    }
                  }
