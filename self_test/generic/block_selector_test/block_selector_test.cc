...
int main(int argc, char* argv[])
{
  ...
  CommandLineArgs::specify_command_line_flag("--test_default_constructor");
  CommandLineArgs::specify_command_line_flag("--test_constructor_with_param");
  CommandLineArgs::specify_command_line_flag("--test_select_block_function");
  CommandLineArgs::specify_command_line_flag("--test_want_block_function");
  CommandLineArgs::specify_command_line_flag(
    "--test_do_not_want_block_function");
  CommandLineArgs::specify_command_line_flag(
    "--test_do_not_want_block_function_replace");
  CommandLineArgs::specify_command_line_flag("--test_set_row_index_function");
  CommandLineArgs::specify_command_line_flag(
  ...
  else
  {
    ...
    err_msg << "No test is recognised.\n"
            << "Please set the appropriate command line flag." << std::endl;
