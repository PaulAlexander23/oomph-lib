...
int main()
{
  ...
  cout << "Multiplying " << CR_matrix1_pt->ncol() << " x "
       << CR_matrix1_pt->nrow() << " matrix by a " << CR_matrix2_pt->ncol()
       << " x " << CR_matrix1_pt->nrow() << " matrix" << endl;
  ...
  cout << "Multiplying " << D_matrix1_pt->ncol() << " x "
       << D_matrix1_pt->nrow() << " matrix by a " << D_matrix2_pt->ncol()
       << " x " << D_matrix1_pt->nrow() << " matrix" << endl;
