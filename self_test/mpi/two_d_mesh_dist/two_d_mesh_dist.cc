                   ...
                   const bool& doc)
{
  ...
  if (my_rank == 0)
  {
    ...
    sprintf(
      filename,
      "%s/"
      "two_d_initial_refinement_nrefinement_%i_ndofbefore_%i_ndofafter_%i.dat",
      doc_info.directory().c_str(),
      n_refine_first,
      n_dof_orig,
      n_dof);
  ...
  for (unsigned i = 0; i < n_refine_once_distributed; i++)
  {
    ...
    if (my_rank == 0)
    {
      ...
      sprintf(filename,
              "%s/"
              "two_d_distributed_refinement_np_%i_ninitialrefinement_%i_"
    ...
    if (redistribute)
    {
      ...
      if (my_rank == 0)
      {
        ...
        sprintf(filename,
                "%s/"
                "two_d_redistribution_np_%i_ninitialrefinement_%i_"
  ...
  if (!redistribute)
  {
    ...
    if (my_rank == 0)
    {
      ...
      sprintf(filename,
              "%s/"
              "two_d_distributed_unrefinement_np_%i_ninitialrefinement_%i_"
              "ntotalrefinement_%i_ndof_%i.dat",
              doc_info.directory().c_str(),
              n_proc,
              n_refine_first,
