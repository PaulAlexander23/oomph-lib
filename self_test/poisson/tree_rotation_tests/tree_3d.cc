...
//=================================================================
template<class ELEMENT>
class TestRefineableCubicMesh : public virtual SimpleCubicMesh<ELEMENT>,
                                public RefineableBrickMesh<ELEMENT>
{
public:
  /// Pass the angle of rotation and the timestepper to
  /// the Mesh.
  TestRefineableCubicMesh(
...
void run_test(const unsigned& i)
{
  ...
  for (unsigned i = 0; i < 24; i++)
  {
    ...
    TestPoissonProblem<ELEMENT> problem(i, &TanhSolnForPoisson::get_source);
